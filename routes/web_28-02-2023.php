...
Route::prefix('admin')->group(function () {
  ...
  Route::group(['middleware' => 'admin.auth'], function () {
    ...
    Route::post('/bussinesspartner/update', [BussinessParatnerController::class, 'update'])->name('admin.bussinesspartner.update');
    ...
    Route::post('/pricings/getsubcategory', [PricingsController::class, 'getsubcategory'])->name('admin.pricings.getsubcategory');
    Route::post('/pricings/getproductdetails', [PricingsController::class, 'getproductdetails'])->name('admin.pricings.getproductdetails');
    ...
    Route::get('/purchaseorder/autocomplete', [PurchaseorderController::class, 'autocomplete'])->name('autocomplete');
    ...
    Route::get('/orderbooking/autocomplete', [OrderbookingController::class, 'autocomplete'])->name('autocomplete');
    ...
    Route::get('/orderfulfilment/autocomplete', [OrderfulfilmentController::class, 'autocomplete'])->name('autocomplete');
    ...
    Route::get('/goodsservicereceipts/autocomplete', [GoodsservicereceiptsController::class, 'autocomplete'])->name('autocomplete');
