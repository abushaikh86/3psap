...
class BintypeController extends Controller
{
  ...
  public function store(Request $request)
  {
    ...
    if ($storagelocations->save()) {
      ...
      $log = ['module' => 'Bin Type', 'action' => 'Bin Type Created', 'description' => 'Bin Type Created: ' . $request->storage_location_name];
      captureActivity($log);
  ...
  public function update(Request $request)
  {
    ...
    if ($storagelocations->update()) {
      ...
      if ($storagelocations->getChanges()) {
        ...
        $log = ['module' => 'Bin Type', 'action' => 'Bin Type Updated', 'description' => 'Bin Type Updated: Name=>' . $storagelocations->storage_location_name];
  ...
  public function destroy($id)
  {
    ...
    $log = ['module' => 'Bin Type', 'action' => 'Bin Type Deleted', 'description' => 'Bin Type Deleted: ' . $storagelocations->storage_location_name];
    captureActivity($log);
