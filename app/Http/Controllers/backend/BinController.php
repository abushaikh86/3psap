...
class BinController extends Controller
{
  ...
  public function store(Request $request)
  {
    ...
    if ($storagelocations->save()) {
      ...
      $log = ['module' => 'Bin Management', 'action' => 'Bin Management Created', 'description' => 'Bin Management Created: ' . $request->storage_location_name];
      captureActivity($log);
  ...
  public function update(Request $request)
  {
    ...
    if ($storagelocations->update()) {
      ...
      if ($storagelocations->getChanges()) {
        ...
        $log = ['module' => 'Bin Management', 'action' => 'Bin Management Updated', 'description' => 'Bin Management Updated: Name=>' . $storagelocations->storage_location_name];
  ...
  public function destroy($id)
  {
    ...
    $log = ['module' => 'Bin Management', 'action' => 'Bin Management Deleted', 'description' => 'Bin Management Deleted: ' . $storagelocations->storage_location_name];
    captureActivity($log);
