    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            return DataTables::of($apinvoice)
                ...
                ->addColumn('new_action', function ($apinvoice) {
                    ...
                    if (request()->user()->can('View A/P Invoice')) {
                        $actionBtn .= ' <li> <a href="' . route('admin.apinvoice.view', ['id' => $apinvoice->goods_service_receipt_id]) . '"
                    class="dropdown-item" id="action_dropdown_item">
                    <span class="badge rounded-pill bg-primary">View</span></a></li> ';
                    }
                    if (request()->user()->can('Update A/P Invoice') && !$apinvoice->is_bill_booking_done) {
                        $actionBtn .= ' <li> <a href="' . route('admin.apinvoice.edit', ['id' => $apinvoice->goods_service_receipt_id]) . '
                     " class="dropdown-item" id="action_dropdown_item">
                     <span class="badge rounded-pill bg-success">Edit</span></a></li>';
                    }
                    if (request()->user()->can('Delete A/P Invoice')) {
                        $actionBtn .= '<li><a href="' . route('admin.apinvoice.delete', ['id' => $apinvoice->goods_service_receipt_id]) . '"
