...
class CompanyController extends Controller
{
  ...
  public function store(Request $request)
  {
    ...
    $validator = Validator::make($request->all(), [
      ...
      // 'ac_start_date' => [
      //   'nullable',
      //   'required_if:ac_end_date,!=null',
      //   'date',
      //   function ($attribute, $value, $fail) use ($request) {
      //     $startDate = new \DateTime($value);
      //     $endDate = new \DateTime($request->input('ac_end_date'));
      ...
      //       $fail('The selected date range must span more than one year.');
      //     }
      //   },
      // ],

      // 'ac_end_date' => 'nullable|required_if:ac_end_date,!=null|date',
