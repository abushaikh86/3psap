...
class OrderfulfilmentController extends Controller
{
        ...
        if ($request->ajax()) {
            ...
            return DataTables::of($purchaseorder)
                ...
                ->addColumn('action', function ($purchaseorder) {
                    ...
                    if (request()->user()->can('View Order Fulfilment/Dispatch')) {
    ...
    public function update(Request $request)
    {
        ...
        if ($totalQuant_gr != $totalQuant_po && $goodsservicereceipt->is_of_done == 0) {
            $this->create_remaining_of($goodsservicereceipt->order_booking_id, $goodsservicereceipt, $existing_items, $difference_arr);
        }
    ...
    public function create_remaining_of($id, $existing_data, $existing_items, $new_quantity)
    {
