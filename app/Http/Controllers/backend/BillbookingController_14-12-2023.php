...
class BillbookingController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            $billbooking = BillBooking::with('get_partyname')->orderby('created_at', 'desc')->get();
    ...
    public function create()
    {
        ...
        return view('backend.billbooking.create', compact('area_data', 'party', 'expense_data', 'gst'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('backend.billbooking.edit', compact('model', 'area_data', 'party', 'expense_data', 'gst'));
    }
        ...
        if ($billbooking->update()) {
            ...
            if (isset($request->old_invoice_items)) {
                ...
                foreach ($old_purchaseorder_items as $old_item) {
                    ...
                    //batches
                    $purchase_order_id = $billbooking->bill_booking_id;
                    $purchase_order_item_id = $purchaseorder_item->bill_booking_item_id;
