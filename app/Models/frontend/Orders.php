...
class Orders extends Model
{
    ...
    protected $fillable = [
      ...
      'order_return_status','order_return_status_date','cancel_orders_no','return_orders_no',
    ...
    {
      return $this->hasMany(OrdersProductDetails::class,'order_id','order_id')->with(['productthumb','products','product_variant']);
    }

    public function paymentinfo()
    {
      return $this->hasOne(PaymentInfo::class,'transaction_id','transaction_id');
    }
    ...
    {
      return $this->hasOne(OrderCancellationReasons::class,'order_cancellation_reason_id','order_cancellation_reason_id');
    }
