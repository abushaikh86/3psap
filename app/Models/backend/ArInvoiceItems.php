...
class ArInvoiceItems extends Authenticatable
{
     ...
     * @var array
     */
    protected $fillable = ['party_id','gst_amount','gst_rate','item_code','order_fulfillment_id','discount_item','price_af_discount','gross_total','order_booking_id','item_name','hsn_sac','qty','taxable_amount','cgst_rate','cgst_amount','sgst_utgst_rate','sgst_utgst_amount','igst_rate','igst_amount','total','storage_location_id'];
