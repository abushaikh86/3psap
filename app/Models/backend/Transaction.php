...
class Transaction extends Model
{
   ...
   */
  protected $fillable = [
    'warehouse_id', 'bin_id', 'batch_no', 'transaction_type','sku', 'user_id', 'fy_year','company_id', 'item_code', 'qty', 'unit_price', 'manufacturing_date', 'expiry_date', 'added_qty', 'final_qty'
  ];
