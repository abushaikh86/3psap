...
class GoodsServiceReceiptsItems extends Authenticatable
{
     ...
     * @var array
     */
    protected $fillable = ['party_id', 'gst_amount', 'item_code', 'sku', 'gst_rate', 'discount_item', 'batch_no', 'manufacturing_date', 'expiry_date', 'price_af_discount', 'gross_total', 'goods_service_receipt_id', 'purchase_order_id', 'item_name', 'hsn_sac', 'qty', 'taxable_amount', 'cgst_rate', 'cgst_amount', 'sgst_utgst_rate', 'sgst_utgst_amount', 'igst_rate', 'igst_amount', 'total', 'storage_location_id'];
