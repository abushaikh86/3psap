...
class Proforma extends Authenticatable
{
     ...
     * @var array
     */
    protected $fillable = ['proforma_id','proforma_counter','discount','status','posting_date','document_date','delivery_date','contact_person','ship_from','customer_ref_no','proforma_no','bill_date','party_id','party_details','financial_year','bill_no','amount_in_words','sub_total','cgst_total','sgst_utgst_total','igst_total','gst_grand_total','grand_total','rounded_off','party_name','bill_to_gst_no','company_gstin','vessel','port','date_of_arrival','date_of_departure','place_of_supply','tax_in_words','split_proforma'];
    ...
    {
        return $this->hasMany(ProformaItems::class,'proforma_id');
    }
