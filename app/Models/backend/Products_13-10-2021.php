...
class Products extends Model
{
  use Sluggable;
    ...
    protected $fillable = [
      ...
      'brand_id', 'size_chart_id','new_arrival','product_thumb','product_discount_type','rating'
    ...
    public static function getAllProducts()
    {
      $data=DB::table('products')
          ...
          ->select('products.product_title','products.product_sub_title','products.product_price','products.product_discounted_price',
              'products.product_discount','products.product_qty','products.product_type','sizes.size_name')
          ->get()->toArray();
      return $data;
    }
}
