                ...
                <div class="row">
                  ...
                  <div class="col-md-12 col-12">
                    <div class="form-label-group">
                      ...
                      <?php echo e(Form::select('parent_roles', Role::where('id','!=',17)->pluck('name', 'id'), null, ['class' => 'form-control
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\3psap\resources\views/backend/roles/create.blade.php ENDPATH**/ ?>