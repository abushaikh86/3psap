...
if ($invoice->igst_total <= 0) { $cs_gst_percent='@ ' . $invoice->gst_rate / 2 . ' %';
                            ...
                            <tr>
                                <td width="80">
                                    <img class="img-fluid for-light"
                                        src="<?php echo e(asset('public/assets/images/logo/logo.png')); ?>" width="80" alt="">
                                </td>
                                <td>
    ...
    <?php endif; ?><?php /**PATH C:\wamp64\www\3psap\resources\views/backend/bankingpayment/invoice_format.blade.php ENDPATH**/ ?>