                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-6">
                                        <div class="form-group">
                                            ...
                                            <?php echo e(Form::select('salesman', $salesman, Auth::user()->admin_user_id ?? request()->segment(3, 'default'), [
                                                'class' => 'form-control ',
...
<?php echo $__env->make('backend.layouts.fullempty', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/3psap/resources/views/backend/outlet/create_web.blade.php ENDPATH**/ ?>