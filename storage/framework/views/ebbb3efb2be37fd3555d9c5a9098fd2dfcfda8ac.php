                                    ...
                                    <div class="col-sm-6">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="col-md-12 col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        <?php echo e(Form::select('party_id', $party, null, ['class' =>
                                                ...
                                                <div class="col-md-12 col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        <?php echo e(Form::hidden('bill_to_gst_no', null, ['class' =>
                                                ...
                                                <div class="col-md-12 col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        <?php echo e(Form::text('vendor_ref_no', null, ['class' => 'form-control
                                        ...
                                        <div class="col-md-3 col-sm-3">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <?php echo e(Form::date('delivery_date', null, ['class' => 'form-control
                                            ...
                                            <div class="form-group">
                                                ...
                                                <?php echo e(Form::date('document_date', date('Y-m-d'), ['class' => 'form-control
                                                                ...
                                                                <div class="table-responsive">
                                                                    <table class="table table-bordered " id="repeater"
                                                                        ...
                                                                        <thead class="bg-light" style="font-size:10px;">
                                                                            <tr>
                                                                                <td class="adjust_col">
                                                                                    <?php echo e(Form::label('item_code', 'Item
                                                                                    Code')); ?>
                                                                                ...
                                                                                <td><?php echo e(Form::label('taxable_amount',
                                                                                    'Unit Price')); ?>
                                                                                ...
                                                                                <td><?php echo e(Form::label('Amount', 'GST
                                                                                    Amount')); ?>

                                                                                </td>
                                                                                <td><?php echo e(Form::label('gross_total', 'Gross
                                                                                    Total')); ?>
                                                                    ...
                                                                    ?>
                                                                            <tr data-repeater-item class="item_row">
                                                                                ...
                                                                                <td style="width: 210px;">
                                                                                    <?php echo e(Form::select('storage_location_id',
                                                                                    $storage_locations,
...
<div class="row">
    ...
    <div class="col-md-3 col-sm-3">
        <div class="form-group">
            ...
            <?php echo e(Form::textarea('remarks', null, ['class' => 'form-control remarks', 'placeholder' => 'Remarks', 'style'
            => 'height:100px;'])); ?>
    ...
    <div class="col-md-3 col-sm-3">
        ...
        <div>
            <p>Discount: <strong><input type="number" name="discount" id="discount" style="width:30px;"
                        onchange="calculate_grand_total()" value="<?php echo e(old('discount') ?? 0); ?>"> %</strong>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\3psap\resources\views/backend/purchaseorder/create.blade.php ENDPATH**/ ?>