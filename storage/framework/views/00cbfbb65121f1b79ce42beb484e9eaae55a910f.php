                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 col-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <?php echo e(Form::textarea('bank_address', null, ['class' => 'form-control', 'placeholder' => 'Enter Bank Address.', 'required' => true, 'rows' => 2, 'cols' => 5, 'id' => 'bank_address', 'style' => "resize:none"  ])); ?>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\3psap\resources\views/backend/bussinesspartner/add_bank.blade.php ENDPATH**/ ?>