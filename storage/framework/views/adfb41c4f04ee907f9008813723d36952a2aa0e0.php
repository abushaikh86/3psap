                    ...
                    <div class="row">
                      <div class="col-md-12 col-12">
                        <div class="form-group">
                          ...
                          <?php echo e(Form::text('name', null, ['class' => 'form-control', 'placeholder' => 'Enter Distributor Name',
                          'required' => true])); ?>
                      ...
                      <div class="col-md-6 col-12">
                        <div class="form-group">
                          ...
                          <?php echo e(Form::number('pincode', null, ['class' => 'form-control', 'placeholder' => 'Enter Pin Code',
                          'required' => true])); ?>
