                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-6">
                                        <div class="form-label-group">
                                            ...
                                            <?php echo e(Form::text('series_number', null, ['class' => 'form-control', 'placeholder' => 'Series Abbreviation', 'required' => true])); ?>
                                    ...
                                    <div class="col-md-6 col-6">
                                        <div class="form-label-group">
                                            ...
                                            <?php echo e(Form::select('module', $modules,null, ['class' => 'form-control', 'placeholder' => 'Select Module Name', 'required' => true])); ?>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\3psap\resources\views/backend/seriesmaster/create.blade.php ENDPATH**/ ?>