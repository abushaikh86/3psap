            ...
            <div class="card">
                <div class="card-content">
                    <div class="card-body card-dashboard">
                        ...
                        <?php echo e(Form::open(['url' => 'admin/beatcalender/store'])); ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-6">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::select('beat_week', $week,null, ['class' => 'form-control',
                                ...
                                <div class="col-md-6 col-6">
                                    <div class="form-group">
                                        ...
                                        <?php echo Form::select('beat_day[]',$days ,
                                ...
                                <div class="col-md-6 col-6">
                                    <div class="form-group">
                                        <?php
                                            ...
                                            $month_data = array_combine($month_data,$month_data);
                                            ?>
                                        <?php echo e(Form::label('beat_month', 'Beat Month *')); ?>

                                        <?php echo e(Form::select('beat_month',$month_data,null, ['class' => 'form-control tags',
                                ...
                                <div class="col-md-6 col-6">
                                    <div class="form-group">
                                        <?php
                                            ...
                                            $year_data = array_combine($year_data,$year_data);
                                            ?>

                                        <?php echo e(Form::label('beat_year', 'Beat Year *')); ?>

                                        <?php echo e(Form::select('beat_year',$year_data,null, ['class' => 'form-control tags',
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/3psap/resources/views/backend/beatcalender/create.blade.php ENDPATH**/ ?>