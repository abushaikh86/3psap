        ...
        <div class="content-header-right col-md-6 col-12 mb-md-0 mb-2">
            <div class="btn-group float-md-right" role="group" aria-label="Button group with nested dropdown">
                <div class="btn-group" role="group">
                    <a class="btn btn-outline-primary" href="<?php echo e(route('admin.users')); ?>">
                        Back
                    </a>
                </div>
            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-12">
                                        <div class="form-label-group">
                                            ...
                                            <?php echo e(Form::hidden('admin_user_id', $userdata->admin_user_id, ['class' => 'form-control'])); ?>
                                            ...
                                            <select name="role" id="role" class='form-control'>
                                                <?php $__currentLoopData = $role; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($value['id']); ?>"
                                                        <?php if($value['id'] == $userdata->role): ?> selected <?php endif; ?>>
                                    ...
                                    <div class="col-md-6 col-12 company_drp">
                                        <div class="form-group">
                                            <?php echo e(Form::label('company_id', 'Compnay *')); ?>
                                ...
                                <div class="col-12">
                                    <div class="col-md-12">
                                        <div class="form-label-group">
                                            ...
                                            <?php echo Form::select('account_status', ['0' => 'Inactive', '1' => 'Active'], $userdata->account_status, [
                                                'class' => 'form-control',
                                            ]); ?>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\3psap\resources\views/backend/admin/edit.blade.php ENDPATH**/ ?>