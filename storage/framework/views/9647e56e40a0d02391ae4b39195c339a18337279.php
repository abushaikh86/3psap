        ...
        <table class="table table-bordered table-striped table-hover" border="1">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td colspan="3"><?php echo e($invoice->get_ship_toaddress->bp_address_name); ?></td>
                </tr>
                <tr>
                    <th>SKU</th>
                ...
                <tr>
                  ...
                  <tr>
                    <td colspan="10" style="text-align: right;">CGST <?php echo e($cs_gst_percent); ?> </td>
                    <td><?php echo e(round($invoice->cgst_total,2)); ?></td>
                  </tr>
                  <tr>
                    <td colspan="10" style="text-align: right;">SGST <?php echo e($st_gst_percent); ?></td>
                    <td><?php echo e(round($invoice->sgst_utgst_total,2)); ?></td>
                  </tr>
                  <tr>
                    <td colspan="10" style="text-align: right;">IGST <?php echo e($igst_percent); ?></td>
