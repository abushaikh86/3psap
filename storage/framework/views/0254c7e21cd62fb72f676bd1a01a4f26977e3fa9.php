...
$user = AdminUsers::where('admin_user_id',request()->segment(3, 'default'))->first();
    ...
    <div class="navbar-container content">
        <div class="collapse navbar-collapse" id="navbar-mobile">
            ...
            <?php
                ...
                // $year_data[$currentYear] = $currentYear;
                // $year_data[$currentYear + 1] = $currentYear + 1;

                // // Add two previous years
                // for ($i = 1; $i <= 2; $i++) {
                //     $previousYear = $currentYear - $i;
                //     $year_data[$previousYear] = $previousYear;
                // }

                // // Sort the array by keys
                // ksort($year_data);
                // session()->put('fy_year', $currentYear);
            ...
            <ul class="nav navbar-nav float-right">
                <li class="dropdown dropdown-user nav-item">
                    <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                        ...
                        ?>
                        <span class="user-name"><?php echo e($user->first_name); ?> <?php echo e($user->last_name); ?> ( <?php echo e($company->name??''); ?> )</span>
...
</nav><?php /**PATH /var/www/html/3psap/resources/views/backend/includes/header_web.blade.php ENDPATH**/ ?>