...
<div class="table-responsive printable mb-4">
        ...
        <table class="table table-bordered table-striped table-hover" border="1">
            <thead>
              <tr>
                <td colspan="7">
                  ...
                  <tr>
                  <td width="80">
                  <img class="img-fluid for-light" src="<?php echo e(asset('public/assets/images/logo/logo.png')); ?>" width="80" alt="">
                  </td>
                  <td>
            ...
            <tbody>
              <tr>
                <td colspan="7" style="text-align:center;font-weight:bold;font-size:20px;">Order Booking</td>
              </tr>
              <tr>
                <td colspan="2">Order Booking No</td>
              ...
              ?>
                <tr>
                  ...
                  <td><?php echo e($item->price_af_discount); ?></td>
...
<?php endif; ?><?php /**PATH /var/www/html/3psap/resources/views/backend/orderbooking/invoice_format.blade.php ENDPATH**/ ?>