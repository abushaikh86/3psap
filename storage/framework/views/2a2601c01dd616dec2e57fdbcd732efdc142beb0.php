                                    ...
                                    <?php if(isset($details) && count($details) > 0): ?>
                                        ...
                                        <?php $__currentLoopData = $details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td><?php echo e($data->outlet_name); ?></td>

                                                <td>
                                   
                                                    
                                                    <a href="<?php echo e(url('admin/outlet/edit/'.$data->id)); ?>" class="btn btn-primary" title="Edit"><i class="feather icon-edit"></i></a>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\3psap\resources\views/backend/outlet/index.blade.php ENDPATH**/ ?>