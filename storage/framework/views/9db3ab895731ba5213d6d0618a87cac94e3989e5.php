                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <?php echo e(Form::text('acc_holdername', $bankdetails->acc_holdername, ['class' => 'form-control', 'placeholder' => 'Enter Account Holder', 'required' => true])); ?>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <?php echo e(Form::text('bank_address', $bankdetails->bank_address, ['class' => 'form-control', 'placeholder' => 'Enter Bank Address.', 'required' => true, 'rows' => 2, 'cols' => 5, 'id' => 'bank_address', 'style' => "resize:none"  ])); ?>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/eureka/resources/views/backend/bussinesspartner/edit_bank.blade.php ENDPATH**/ ?>