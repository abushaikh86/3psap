                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <div class="content-header row">
                                ...
                                <?php echo e(Form::model($model, ['url' => 'admin/goodsservicereceipts/update', 'files' => true, 'class' => 'w-100'])); ?>
                                            ...
                                            <section id="form-repeater-wrapper">
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                                    ...
                                                                    <tbody data-repeater-list="old_invoice_items">
                                                                        ...
                                                                        <?php $__currentLoopData = $model->goodsservicereceipts_items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $items): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                            ...
                                                                            <tr data-repeater-item
                                                                                ...
                                                                                <td>
                                                                                    <?php echo e(Form::number('old_invoice_items[' . $loop->index . '][qty]', $items->qty, ['class' => 'form-control qty', 'onchange' => 'calculategst(this)', 'oninput' => 'validateInputZero(this)', 'data-name' => 'qty', 'data-group' => 'old_invoice_items', 'required' => true])); ?>
                                                                                ...
                                                                                <td style="width: 210px;">
                                                                                    <?php echo e(Form::select('old_invoice_items[' . $loop->index . '][storage_location_id]', $storage_locations, $items->storage_location_id, ['class' => 'form-control  selected_' . $items->storage_location_id, 'data-selected' => $items->storage_location_id, 'placeholder' => 'Warehouse', 'data-name' => 'storage_location_id', 'required' => true])); ?>
                                                        ...
                                                        <?php else: ?>
                                                            <?php echo e(Form::hidden('old_invoice_items[' . $loop->index . '][batch_no]', $items->batch_no, ['class' => 'form-control  def_batch_no', 'data-name' => 'batch_no', 'data-group' => 'old_invoice_items'])); ?>
                                                            ...
                                                            <td><button type='button'
                                                                    ...
                                                                    id="<?php echo e($loop->index); ?>" data-repeater-delete><i
        ...
        <div class="col-md-3 col-sm-3">
            ...
            <div>
                <p>Discount: <strong><input type="number" name="discount" id="discount" style="width:30px;"
                            value="<?php echo e($model->discount); ?>" onchange="calculate_grand_total()">
                        %</strong>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/3psap/resources/views/backend/goodsservicereceipts/edit.blade.php ENDPATH**/ ?>