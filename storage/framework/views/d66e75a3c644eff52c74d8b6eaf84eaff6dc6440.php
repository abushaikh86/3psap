...
<?php $__env->startSection('content'); ?>
    ...
    <div class="content-header row">
        ...
        <div class="content-header-right col-md-6 col-12 mb-md-0 mb-2">
            <div class="btn-group float-md-right" role="group" aria-label="Button group with nested dropdown">
                <a href="<?php echo e(route('admin.stockmanagement.bin_transfer_history')); ?>" class="btn btn-secondary">Bin Transfer Histroy</a>
            </div>
        </div>
    </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            //get batch data from sku
            $(document).on('change', '.sku', function() {
                var sku = $(this).val();
                var batchDropdwon = $(this).closest('.item_row').find('.batch');
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/parasigh/public_html/3psap/resources/views/backend/stockmanagement/index.blade.php ENDPATH**/ ?>