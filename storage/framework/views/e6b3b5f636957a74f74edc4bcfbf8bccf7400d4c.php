...
<?php $__env->startSection('title', 'Create Sale Pricing'); ?>
        ...
        <div class="row breadcrumbs-top">
            <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">
                        <a href="<?php echo e(route('admin.sellingpricing')); ?>">Sale Pricing</a>
                    </li>
            ...
            <div class="card">
                ...
                <div class="card-content">
                    <div class="card-body">
                        ...
                        <?php echo e(Form::open(['url' => 'admin/sellingpricing/store', 'enctype' => 'multipart/form-data'])); ?>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\3psap\resources\views/backend/sellingpricing/create.blade.php ENDPATH**/ ?>