                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-6">
                                    <div class="form-label-group">
                                        ...
                                        <?php echo e(Form::text('city', null, ['class' => 'form-control', 'placeholder' => 'Name
                                        of City', 'required' => true])); ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-6">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::select('salesman', $salesman, Auth::user()->admin_user_id ??
                                        request()->segment(3, 'default'), ['class' =>
                                ...
                                <div class="col-md-6 col-6">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::select('sales_execu', $sales_execu_data, null, ['class' =>
                                        'form-control select2', 'placeholder' => 'Select Sales Executive', 'required' =>
                                        true])); ?>
                                ...
                                <div class="col-md-6 col-6">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::select('ase', $ase_data, null, ['class' => 'form-control select2',
                                        'placeholder' => 'Select ASE', 'required' => true])); ?>
                                ...
                                <div class="col-md-6 col-6">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::select('asm', $asm_data, null, ['class' => 'form-control select2',
                                        'placeholder' => 'Select ASM', 'required' => true])); ?>
