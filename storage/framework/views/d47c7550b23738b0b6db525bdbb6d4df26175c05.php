<script type="text/javascript">
    ...
    function initTypeaheadForElement(element) {
        ...
        $(element).typeahead({
            ...
            updater: function(item) {
                ...
                // $("input[name='" + group + "[" + index + "][qty]']").val(1);
                ...
                if (bill_to_state == party_state) {
                    ...
                    $("input[name='" + group + "[" + index + "][sgst_utgst_rate]']").val(divided_percent);
    ...
    $(document).on('click', '.add_btn_rep', function() {
        ...
        // var inputs = document.querySelectorAll('input.typeahead');


        // Array.from(inputs).forEach(function(input) {
        //     initTypeaheadForElement(input);
        // });
    });
...
<?php /**PATH /var/www/html/3psap/resources/views/backend/autocomplete_typeahead_script.blade.php ENDPATH**/ ?>