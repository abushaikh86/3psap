...
<div class="col-sm-12 text-sm-end mb-1">
  ...
  <?php echo $__env->make('backend.arinvoice.invoice_format_split', ['roles'=>$roles,'invoice'=>$goodsservicereceipts,'party'=>$party,'bill_address'=>$bill_address,'ship_address'=>$ship_address,'contact'=>$contact,'download'=>false], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
  <?php else: ?>
  <?php echo $__env->make('backend.arinvoice.invoice_format', ['roles'=>$roles,'invoice'=>$goodsservicereceipts,'party'=>$party,'bill_address'=>$bill_address,'ship_address'=>$ship_address,'contact'=>$contact,'download'=>false], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
  <?php endif; ?>
      <div class="row">
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/3psap/resources/views/backend/arinvoice/show.blade.php ENDPATH**/ ?>