...
<div class="table-responsive printable mb-4">
        ...
        <table class="table table-bordered table-striped table-hover" border="1">
            ...
            <tbody>
              <tr>
                <td colspan="7" style="text-align:center;font-weight:bold;font-size:20px;">Sales Order</td>
              </tr>
              <tr>
...
<?php endif; ?><?php /**PATH /var/www/html/eureka/resources/views/backend/orderbooking/invoice_format.blade.php ENDPATH**/ ?>