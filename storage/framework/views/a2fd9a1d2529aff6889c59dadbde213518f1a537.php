            ...
            <div class="card">
                <div class="card-content">
                    <div class="card-body">
                        ...
                        <?php echo e(Form::open(['url' => 'admin/updatepricings/update', 'class' =>
                        'w-100','enctype'=>'multipart/form-data'])); ?>
...
<script>
    var table = $('#tbl-datatable').DataTable({
        ...
        columns: [
            ...
            { data: 'consumer_desc', name: 'consumer_desc' },
            { data: 'brand.brand_name', name: 'brand.brand_name' },
            { data: 'category.category_name', name: 'category.category_name' },
            { data: 'sub_category.subcategory_name', name: 'sub_category.subcategory_name' },
            { data: 'variants.name', name: 'variants.name' },
