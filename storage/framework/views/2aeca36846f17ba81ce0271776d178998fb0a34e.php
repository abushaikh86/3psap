<?php $__env->startSection('title', 'Update Outlet'); ?>
<?php
            ...
            <div class="card">
                <div class="card-content">
                    <div class="card-body card-dashboard">
                        ...
                        <?php echo e(Form::model($model, ['url' => 'admin/outlet/update', 'files' => true, 'class' => 'w-100'])); ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-6">
                                        <div class="form-label-group">
                                            ...
                                            <?php echo e(Form::number('phone', null, ['class' => 'form-control', 'placeholder' =>
                                            'Phone', 'required' => true])); ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-6">
                                        <div class="form-group">
                                            ...
                                            <?php echo e(Form::select('area_id', $area_data, $model->area_id, ['class' =>
                                    ...
                                    <div class="col-md-6 col-6">
                                        <div class="form-group">
                                            ...
                                            <?php echo e(Form::select('salesman', $salesman, $model->salesman, ['class' =>
                                    ...
                                    <div class="col-md-6 col-6">
                                        <div class="form-group">
                                            ...
                                            <?php echo e(Form::select('sales_execu', $sales_execu_data, $model->sales_execu,
                                            ['class' => 'form-control select2', 'placeholder' => 'Select Sales
                                    ...
                                    <div class="col-md-6 col-6">
                                        <div class="form-group">
                                            ...
                                            <?php echo e(Form::select('ase', $ase_data, $model->ase, ['class' => 'form-control
                                            select2', 'placeholder' => 'Select ASE', 'required' => true])); ?>
                                    ...
                                    <div class="col-md-6 col-6">
                                        <div class="form-group">
                                            ...
                                            <?php echo e(Form::select('asm', $asm_data, $model->asm, ['class' => 'form-control
                                            select2', 'placeholder' => 'Select ASM', 'required' => true])); ?>
...
<script>
    var country_selected = `<?php echo e(old('country') ?? $model->country ?? ''); ?>`;
        var state_selected = `<?php echo e(old('state') ?? $model->state ?? ''); ?>`;
        var district_selected = `<?php echo e(old('district') ?? $model->district ?? ''); ?>`;
</script>

<?php $__env->stopSection(); ?>
<?php echo $__env->make(request()->is('api/*') ? 'backend.layouts.appempty' : 'backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\3psap\resources\views/backend/outlet/edit.blade.php ENDPATH**/ ?>