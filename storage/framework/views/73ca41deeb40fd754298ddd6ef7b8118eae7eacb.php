                ...
                <thead>
                  <tr>
                    ...
                    <th>Beat
                      <div class="my-1">
                        <div class="dropdown">
                          ...
                          null, ['id'=>'beat_id','placeholder'=>'Select Beat']); ?>
                    ...
                    <th>Day
                      <div class="my-1">
                        <div class="dropdown">
                          ...
                          null, ['id'=>'beat_day','placeholder'=>'Select Day']); ?>
                    ...
                    <th>Week
                      <div class="my-1">
                        <div class="dropdown">
                          <?php echo Form::select('beat_week',$all_data['week'] ,
                          null, ['id'=>'beat_week','placeholder'=>'Select Week']); ?>
                    ...
                    <th>Month
                      <div class="my-1">
                        <div class="dropdown">
                          <?php echo Form::select('beat_month',$all_data['month'] ,
                          null, ['id'=>'beat_month','placeholder'=>'Select Month']); ?>
                    ...
                    <th>Year
                      <div class="my-1">
                        <div class="dropdown">
                          <?php echo Form::select('beat_year',$all_data['year'] ,
                          null, ['id'=>'beat_year','placeholder'=>'Select Year']); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\3psap\resources\views/backend/beatcalender/index.blade.php ENDPATH**/ ?>