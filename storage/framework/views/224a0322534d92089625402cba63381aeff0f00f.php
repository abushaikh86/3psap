                        ...
                        <div class="form-body ">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            ...
                                            <div class="col-md-12 col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <?php echo e(Form::select('transaction_type', ['neft' => 'NEFT', 'imps' =>
                                            ...
                                            <div class="col-md-12 col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <?php echo e(Form::text('overdue_range', null, ['class' => 'form-control
                                            ...
                                            <div class="col-md-12 col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <?php echo e(Form::select('payment_type', ['regular' => 'Regular', 'urgent' =>
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="col-sm-12">
                                                <div class="col-md-12 col-sm-12">
                                                    <div class="form-group">
                                                        <?php echo e(Form::label('vendor_id', 'Business Partner Code *')); ?>

                                                        <?php echo e(Form::select('vendor_id', $party_code, null, ['class' =>
                                            ...
                                            <div class="col-sm-12">
                                                <div class="col-md-12 col-sm-12">
                                                    <div class="form-group">
                                                        <?php echo e(Form::label('vendor_id', 'Business Partner Type *')); ?>
                            ...
                            <div class="col-md-3 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::select('bank', [], null, ['class' => 'form-control', 'id' => 'bank_id',
           ...
           // Assuming that party_id and party_code are the IDs of your party select elements
            $('#party_id, #party_code').change(function() {
                ...
                $.ajax({
                    ...
                    url: '<?php echo e(route("admin.bank")); ?>',
                    data: {
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/parasigh/public_html/3psap/resources/views/backend/bankingpayment/create.blade.php ENDPATH**/ ?>