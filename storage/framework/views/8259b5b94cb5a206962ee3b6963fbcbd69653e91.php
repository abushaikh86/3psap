                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <div class="content-header row">
                                ...
                                <?php echo e(Form::model($model, ['url' => 'admin/purchaseorder/update', 'files' => true, 'class' => 'w-100'])); ?>
                                                                    ...
                                                                    <tbody data-repeater-list="old_invoice_items">
                                                                        ...
                                                                        <?php $__currentLoopData = $model->purchaseorder_items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $items): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                            ...
                                                                            <tr data-repeater-item
                                                                                ...
                                                                                <?php echo e(Form::hidden('old_invoice_items[' . $loop->index . '][purchase_order_item_id]', $items->purchase_order_item_id, ['data-name' => 'purchase_order_item_id', 'class' => 'form-control item_name typeahead', 'placeholder' => 'Description', 'required' => true, 'autocomplete' => 'off'])); ?>
                                                                                ...
                                                                                <td style="width: 210px;">
                                                                                    <?php echo e(Form::select('old_invoice_items[' . $loop->index . '][storage_location_id]', $storage_locations, $items->storage_location_id, ['class' => 'form-control  storage_locations selected_' . $items->storage_location_id, 'data-selected' => $items->storage_location_id, 'placeholder' => 'Warehouse', 'data-name' => 'storage_location_id', 'required' => true])); ?>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/3psap/resources/views/backend/purchaseorder/edit.blade.php ENDPATH**/ ?>