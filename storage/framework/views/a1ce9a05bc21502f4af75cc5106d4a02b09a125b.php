                                                        ...
                                                        <table class="table table-bordered " id="repeater"
                                                            ...
                                                            <tbody data-repeater-list="old_invoice_items">
                                                                ...
                                                                <tr data-repeater-item class="item_row item-content"
                                                                    ...
                                                                    <td>
                                                                        <?php echo e(Form::number('old_invoice_items[' .
                                                                        $loop->index . '][avail_qty]', $get_total_qty, [
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/eureka/resources/views/backend/orderfulfilment/edit.blade.php ENDPATH**/ ?>