                                ...
                                <div class="row">
                                    <div class="col-md-6 col-12">
                                        <div class="form-label-group">
                                            ...
                                            <?php echo e(Form::select('business_partner_type', $bussinesstype, null, ['class' => 'form-control', 'placeholder' => 'Select Business Partner Type', 'required' => true])); ?>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-label-group">
                                            ...
                                            <?php echo e(Form::text('bp_name', null, ['class' => 'form-control', 'placeholder' => 'Business Partner Name', 'required' => true])); ?>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-label-group">
                                            ...
                                            <?php echo e(Form::select('bp_organisation_type', $bpOrgType, null, ['class' => 'form-control', 'placeholder' => 'Select Business Partner Organization Type', 'required' => true])); ?>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-label-group">
                                            ...
                                            <?php echo e(Form::select('residential_status', ['resident' => 'Resident', 'non-resident' => 'Non Resident', 'indian-company' => 'Indian company', 'foriegn-company' => 'Foriegn company'], null, ['class' => 'form-control', 'placeholder' => 'Select Residential status', 'required' => true])); ?>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-label-group">
                                            ...
                                            <?php echo e(Form::select('bp_category', $business_partner_category, null, ['class' => 'form-control  select2 ', 'placeholder' => 'Business Partner Category', 'required' => true])); ?>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-label-group">
                                            ...
                                            <?php echo e(Form::text('bp_group', null, ['class' => 'form-control', 'placeholder' => 'Business Partner Group', 'required' => true])); ?>
                                    ...
                                    <div class="col-md-6 col-12 d-none sm_dynamic">
                                        ...
                                        <div class="form-label-group">
                                            <?php echo e(Form::label('sales_manager', 'Sales Manager *')); ?>

                                            <?php echo e(Form::select('sales_manager', $sales_manager, null, ['class' => 'form-control select2', 'placeholder' => 'Sales Manager'])); ?>
                                    ...
                                    <div class="col-md-6 col-12 d-none sm_dynamic">
                                        ...
                                        <div class="form-label-group">
                                            ...
                                            <?php echo e(Form::select('sales_officer', $sales_officer, null, ['class' => 'form-control select2', 'placeholder' => 'Sales Officer'])); ?>
                                    ...
                                    <div class="col-md-6 col-12 d-none sm_dynamic">
                                        <div class="form-label-group">
                                            ...
                                            <?php echo e(Form::select('salesman', $salesman, null, ['class' => 'form-control select2', 'placeholder' => 'Salesman'])); ?>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-label-group">
                                            ...
                                            <?php echo e(Form::select('payment_terms_id', $termPayment, null, ['class' => 'form-control', 'placeholder' => 'Select Terms of Payment', 'required' => true])); ?>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-label-group">
                                            ...
                                            <?php echo e(Form::text('gst_details', null, ['class' => 'form-control', 'placeholder' => 'GST Number', 'required' => true])); ?>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-label-group">
                                            ...
                                            <?php echo e(Form::select('gst_reg_type', ['composite' => 'Composite', 'regular' => 'Regular'], null, ['class' => 'form-control', 'placeholder' => 'Select GST Registration Type', 'required' => true])); ?>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-label-group">
                                            ...
                                            <?php echo e(Form::select('pricing_profile', $pricing_data, null, ['class' => 'form-control', 'placeholder' => 'Select Pricing Profile', 'required' => true])); ?>
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <div class=" col-12">
                                                    <div class="form-label-group">
                                                        ...
                                                        <?php echo e(Form::text('bp_address_name', null, ['class' => 'form-control', 'placeholder' => 'Address Name', 'required' => true])); ?>
                                                ...
                                                <div class=" col-12">
                                                    <div class="form-label-group">
                                                        ...
                                                        <?php echo e(Form::number('pin_code', null, ['class' => 'form-control', 'onkeypress' => 'return event.charCode === 0 || /\d/.test(String.fromCharCode(event.charCode));', 'placeholder' => 'Pin Code', 'required' => true])); ?>
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <div class=" col-12">
                                                    <div class="form-label-group">
                                                        ...
                                                        <?php echo e(Form::text('bp_address_name1', null, ['class' => 'form-control', 'placeholder' => 'Address Name', 'required' => true])); ?>
                                                ...
                                                <div class=" col-12">
                                                    <div class="form-label-group">
                                                        ...
                                                        <?php echo e(Form::text('building_no_name1', null, ['class' => 'form-control', 'placeholder' => 'Building No and Name', 'required' => true])); ?>
                                                ...
                                                <div class=" col-12">
                                                    <div class="form-label-group">
                                                        ...
                                                        <?php echo e(Form::text('street_name1', null, ['class' => 'form-control', 'placeholder' => 'Street Name', 'required' => true])); ?>
                                                ...
                                                <div class=" col-12">
                                                    <div class="form-label-group">
                                                        ...
                                                        <?php echo e(Form::select('country1', [], null, ['class' => 'form-control ', 'required' => true])); ?>
                                                ...
                                                <div class=" col-12">
                                                    <div class="form-label-group">
                                                        ...
                                                        <?php echo e(Form::number('pin_code1', null, ['class' => 'form-control', 'onkeypress' => 'return event.charCode === 0 || /\d/.test(String.fromCharCode(event.charCode));', 'placeholder' => 'Pin Code', 'required' => true])); ?>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-label-group">
                                            ...
                                            <?php echo e(Form::text('email_id', null, ['class' => 'form-control', 'placeholder' => 'Email', 'required' => true])); ?>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-label-group">
                                            ...
                                            <?php echo e(Form::number('mobile_no', null, ['class' => 'form-control', 'onkeypress' => 'return event.charCode === 0 || /\d/.test(String.fromCharCode(event.charCode));', 'placeholder' => 'Mobile No', 'required' => true])); ?>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-label-group">
                                            ...
                                            <?php echo e(Form::text('acc_holdername', null, ['class' => 'form-control', 'placeholder' => 'Account Holder Name', 'required' => true])); ?>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-label-group">
                                            ...
                                            <?php echo e(Form::text('bank_branch', null, ['class' => 'form-control', 'placeholder' => 'Branch Name', 'required' => true])); ?>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-label-group">
                                            ...
                                            <?php echo e(Form::text('ifsc', null, ['class' => 'form-control', 'maxlength' => '15', 'placeholder' => 'IFSC Code', 'required' => true])); ?>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-label-group">
                                            ...
                                            <?php echo e(Form::text('ac_number', null, ['class' => 'form-control', 'placeholder' => 'Account No', 'required' => true])); ?>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-label-group">
                                            ...
                                            <?php echo e(Form::text('bank_address', null, ['class' => 'form-control', 'placeholder' => 'Bank Address', 'required' => true])); ?>
                                    ...
                                    <div class="col-md-6 col-12 d-none beat_det">
                                        <div class="form-group">
                                            ...
                                            <?php echo e(Form::select('beat_id', Beat::pluck('beat_name', 'beat_id'), null, ['class' => 'form-control select2', 'placeholder' => 'Select Beat'])); ?>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-12">
                            <div class="form-group">
                                ...
                                <?php echo e(Form::text('area_name', null, ['class' => 'form-control', 'placeholder' => 'Enter Area Name', 'required' => true])); ?>
                    ...
                    <div class="col-md-12 col-12">
                        <div class="form-group">
                            <?php echo e(Form::label('area_id', 'Select Area *')); ?>
                                ...
                                <?php echo e(Form::select('area_id', $area_data, null, ['class' => 'form-control select2 area_id', 'placeholder' => 'Select Area'])); ?>
                     ...
                     <div class="col-md-12 col-12">
                         <div class="form-group">
                             ...
                             <?php echo e(Form::text('route_name', null, ['class' => 'form-control', 'placeholder' => 'Enter Route Name', 'required' => true])); ?>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-12">
                            <div class="form-group">
                                ...
                                <?php echo e(Form::text('beat_name', null, ['class' => 'form-control', 'placeholder' => 'Enter Beat Name', 'required' => true])); ?>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-12">
                            <div class="form-group">
                                ...
                                <?php echo e(Form::text('bp_category', null, ['class' => 'form-control', 'id' => 'bp_category_modal', 'placeholder' => 'Business Partner Category', 'required' => true])); ?>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-12">
                            <div class="form-group">
                                ...
                                <?php echo e(Form::text('first_name', null, ['class' => 'form-control', 'id' => 'first_name_modal', 'placeholder' => 'First Name', 'required' => true])); ?>
                        ...
                        <div class="col-md-12 col-12">
                            <div class="form-group">
                                ...
                                <?php echo e(Form::text('last_name', null, ['class' => 'form-control', 'id' => 'last_name_modal', 'placeholder' => 'Last Name', 'required' => true])); ?>
                        ...
                        <div class="col-md-12 col-12">
                            <div class="form-group">
                                ...
                                <?php echo e(Form::email('email', null, ['class' => 'form-control', 'id' => 'email_modal', 'placeholder' => 'email', 'required' => true])); ?>
    ...
    <script>
        $(document).ready(function() {
            ...
            new MasterHandler('#sales_manager', '#add_sales_manager_modal', '#submit_sales_manager',
                '<?php echo e(url('admin/master/store_users')); ?>', 12, '#first_name_modal',
                '#last_name_modal', '#email_modal');
            new MasterHandler('#sales_officer', '#add_sales_officer_modal', '#submit_sales_officer',
                '<?php echo e(url('admin/master/store_users')); ?>', 10, '#first_name_modal',
                '#last_name_modal', '#email_modal');
            new MasterHandler('#salesman', '#add_salesman_modal', '#submit_salesman',
                '<?php echo e(url('admin/master/store_users')); ?>', 11, '#first_name_modal',
                '#last_name_modal', '#email_modal');

            new MasterHandler('.area_id', '#add_area_modal', '#submit_area', '<?php echo e(url('admin/master/store_area')); ?>', '',
                '#area_name');

            new MasterHandler('#route_id', '#add_route_modal', '#submit_route', '<?php echo e(url('admin/master/store_route')); ?>', '',
            '.area_id','#route_name');

            new MasterHandler('#beat_id', '#add_beat_modal', '#submit_beat', '<?php echo e(url('admin/master/store_beat')); ?>', '',
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\3psap\resources\views/backend/bussinesspartner/create.blade.php ENDPATH**/ ?>