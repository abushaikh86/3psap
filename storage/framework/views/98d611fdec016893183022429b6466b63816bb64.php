                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-6">
                                        <div class="form-label-group">
                                            ...
                                            <?php echo e(Form::text('outlet_name', null, ['class' => 'form-control', 'placeholder' => 'Enter Name', 'required' => true])); ?>
                                    ...
                                    <div class="col-md-6 col-6">
                                        <div class="form-label-group">
                                            ...
                                            <?php echo e(Form::number('phone', null, ['class' => 'form-control', 'placeholder' => 'Phone', 'required' => true])); ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-6">
                                        <div class="form-group">
                                            ...
                                            <?php echo e(Form::select('area_id', $area_data, '', ['class' => 'form-control select2', 'id' => 'area_field', 'placeholder' => 'Select Area', 'required' => true])); ?>
                                    ...
                                    <div class="col-md-6 col-6">
                                        <div class="form-group">
                                            ...
                                            $defaultDayIndex = array_search(now()->format('l'), $days);
                                            ?>
                                            <?php echo e(Form::label('beat_day', 'Beat Day *')); ?>

                                            <?php echo Form::select('beat_day[]', $days, $defaultDayIndex, [
                                                'class' => 'form-control ',
                                                // 'multiple' => 'multiple',
                                            ]); ?>
                                    ...
                                    <div class="col-md-6 col-6">
                                        <div class="form-group">
                                            ...
                                            <?php echo e(Form::select('salesman', $salesman, Auth::user()->admin_user_id, ['class' => 'form-control ', 'placeholder' => 'Select Salesman', 'required' => true])); ?>
                                    ...
                                    <div class="col-md-6 col-6">
                                        <div class="form-group">
                                            <?php echo e(Form::label('sales_execu', 'Sales Executive *')); ?>

                                            <?php echo e(Form::select('sales_execu', $sales_execu_data, null, ['class' => 'form-control select2', 'placeholder' => 'Select Sales Executive', 'required' => true])); ?>
                                    ...
                                    <div class="col-md-6 col-6">
                                        <div class="form-group">
                                            ...
                                            <?php echo e(Form::select('ase', $ase_data, null, ['class' => 'form-control select2', 'placeholder' => 'Select ASE', 'required' => true])); ?>

                                        </div>
                                    </div>
                                    <div class="col-md-6 col-6">
                                        <div class="form-group">
                                            <?php echo e(Form::label('asm', 'ASM *')); ?>

                                            <?php echo e(Form::select('asm', $asm_data, null, ['class' => 'form-control select2', 'placeholder' => 'Select ASM', 'required' => true])); ?>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/3psap/resources/views/backend/outlet/create.blade.php ENDPATH**/ ?>