                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <div class="col-md-12 col-sm-12">
                                                        <div class="form-group">
                                                            ...
                                                            <?php echo e(Form::date('invoice_ref_date', null, [
                                                        ...
                                                        <table class="table table-bordered " id="repeater"
                                                            ...
                                                            <tbody data-repeater-list="invoice_items">
                                                                ...
                                                                <tr data-repeater-item class="item_row ">
                                                                    ...
                                                                    <td><?php echo e(Form::text('description', old('invoice_items')[$i]['description'] ?? null, [
                                                                        'data-id' => 'description',
                                                                        'id' => 'description',
                                                                    ...
                                                                    <td class="adjust_col">
                                                                        <?php echo e(Form::text('invoice_ref_no', old('invoice_items')[$i]['invoice_ref_no'] ?? null, [
                                                                    ...
                                                                    <td class="adjust_col">
                                                                        <?php echo e(Form::select('expense_id', $expense_data, old('invoice_items')[$i]['expense_id'] ?? null, [
                                                                            'data-id' => 'particular',
                                                                            'id' => 'expense_id',
                                                                    ...
                                                                    <td class="adjust_col">
                                                                        <?php echo e(Form::select('bsplstype_id', [], old('invoice_items')[$i]['bsplstype_id'] ?? null, [
                                                                    ...
                                                                    <td class="adjust_col">
                                                                        <?php echo e(Form::select('bsplsubcat_id', [], old('invoice_items')[$i]['bsplsubcat_id'] ?? null, [
                                                                    ...
                                                                    <td class="adjust_col">
                                                                        <?php echo e(Form::select('bsplcat_id', [], old('invoice_items')[$i]['bsplcat_id'] ?? null, [
                                                                    ...
                                                                    <td class="adjust_col">
                                                                        <?php echo e(Form::select('bsplheads_id', [], old('invoice_items')[$i]['bsplheads_id'] ?? null, [
                                                                    ...
                                                                    <td class="adjust_col">
                                                                        <?php echo e(Form::select('gl_code', [], old('invoice_items')[$i]['gl_code'] ?? null, [
                                                                    ...
                                                                    <td class="adjust_col">
                                                                        <?php echo e(Form::text('amount', old('invoice_items')[$i]['amount'] ?? null, [
