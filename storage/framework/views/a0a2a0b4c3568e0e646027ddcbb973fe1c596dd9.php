                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-6">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::select('beat_week', $week,$model->beat_week, ['class' =>
                                ...
                                <div class="col-md-6 col-6">
                                    <div class="form-group">
                                        ...
                                        $multi_beat_days, ['class' => 'form-control tags','multiple' => 'multiple']); ?>
                                ...
                                <div class="col-md-6 col-6">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::select('beat_month',$month_data,$model->beat_month, ['class' =>
                                ...
                                <div class="col-md-6 col-6">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::select('beat_year',$year_data,$model->beat_year, ['class' =>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/3psap/resources/views/backend/beatcalender/edit.blade.php ENDPATH**/ ?>