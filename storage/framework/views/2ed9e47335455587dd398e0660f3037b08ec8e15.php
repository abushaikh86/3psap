                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <?php echo e(Form::select('variant', $variants, null, ['class' => 'select2 form-control', 'placeholder' => 'Select Variant', 'id' => 'variant'])); ?>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/parasigh/public_html/3psap/resources/views/backend/products/edit.blade.php ENDPATH**/ ?>