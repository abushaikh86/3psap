              ...
              <table class="table zero-configuration" id="tbl-datatable">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <?php
                    $modules = DB::table('modules')->where('id',$data->module)->pluck('name', 'id');
                    ?>
                    ...
                    <td>
                      ...
                      <a href="<?php echo e(url('admin/seriesmaster/edit/'.$data->id)); ?>" class="btn btn-primary" title="Edit"><i
                      ...
                      <?php echo Form::button('<i class="feather icon-trash"></i>', ['type' => 'submit','title'=>'Delete',
                      'class' => 'btn btn-danger','onclick'=>"return confirm('Are you sure you want to Delete this Entry
                      ?')"]); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\3psap\resources\views/backend/seriesmaster/index.blade.php ENDPATH**/ ?>