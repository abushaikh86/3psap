                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <div class=" col-12">
                                                    <div class="form-label-group">
                                                        ...
                                                        <?php echo e(Form::text('email_id1', null, ['class' => 'form-control', 'placeholder' => 'Email', 'required' => true])); ?>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#company_id,#business_partner_type').change(function(){
                if($('#business_partner_type').val() && $('#business_partner_type').val()){
                if (bptype == 'Customer') {
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/eureka/resources/views/backend/bussinesspartner/create.blade.php ENDPATH**/ ?>