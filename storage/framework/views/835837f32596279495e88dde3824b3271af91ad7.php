...
<table style="width: 100%">
        ...
        <tr>
          <td colspan="10" style="width: 50%">
            Place Of Supply:<br />
            <b><?php echo e($invoice->ship_from); ?></b>
          </td>
        </tr>
        ...
        <tr>
          ...
          <td colspan="10">
            Bill To
            <h5><?php echo e($party->bp_name ?? ''); ?></h5>
            Address : <?php echo e($bill_address->building_no_name. " ,".$bill_address->street_name ." ,". $bill_address->landmark
             ." ,". $bill_address->city." ".$bill_address->district." ".$bill_address->pin_code); ?><br />
            Phone No: <?php echo e($contact->mobile_no); ?> <br />
            GSTIN:  <?php echo e($invoice->bill_to_gst_no); ?><br />
            State: <?php echo e($bill_address->state); ?>
...
<?php endif; ?><?php /**PATH /var/www/html/3psap/resources/views/backend/apinvoice/invoice_format.blade.php ENDPATH**/ ?>