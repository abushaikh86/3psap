                                                                ...
                                                                <table class="table table-bordered " id="repeater"
                                                                    ...
                                                                    <tbody data-repeater-list="old_invoice_items">
                                                                        ...
                                                                        <tr data-repeater-item class="item_row item-content"
                                                                            ...
                                                                            <td>
                                                                                <?php echo e(Form::text('old_invoice_items[' . $i . '][hsn_sac]', null, ['class' => 'form-control readonly', 'data-name' => 'hsn_sac', 'required' => true])); ?>
                                                                            ...
                                                                            <td>
                                                                                <?php echo e(Form::number('old_invoice_items[' . $i . '][taxable_amount]',null, ['class' => 'form-control taxable_amount readonly', 'onchange' => 'calculategst(this)', 'data-name' => 'taxable_amount', 'data-group' => 'old_invoice_items', 'required' => true])); ?>
                                                                            ...
                                                                            <td style="width: 130px;">
                                                                                <?php echo e(Form::select('old_invoice_items[' . $i . '][gst_rate]', $gst, null, ['class' => 'form-control gst_dropdown readonly', 'placeholder' => 'Select GST', 'onchange' => 'calculategst(this)', 'data-name' => 'gst_rate', 'data-group' => 'old_invoice_items', 'required' => true])); ?>
                                                                            ...
                                                                            <td>
                                                                                <?php echo e(Form::text('old_invoice_items[' . $i . '][gst_amount]', null, ['class' => 'form-control readonly', 'placeholder' => 'GST Amount', 'onchange' => 'calculategst(this)', 'data-name' => 'gst_amount', 'data-group' => 'old_invoice_items', 'required' => true])); ?>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/3psap/resources/views/backend/inventoryrectification/goodsissue_create.blade.php ENDPATH**/ ?>