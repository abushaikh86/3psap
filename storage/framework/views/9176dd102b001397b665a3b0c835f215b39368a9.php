<?php $__env->startSection('title', 'Create Banking Receipt '); ?>
    ...
    <div class="content-header-right col-md-6 col-12 mb-md-0 mb-2">
        <div class="btn-group float-md-right" role="group" aria-label="Button group with nested dropdown">
            <div class="btn-group" role="group">
                <a href="<?php echo e(route('admin.bankingreceipt')); ?>" class="btn btn-outline-secondary float-right"><i
            ...
            <div class="card ">
                <div class="card-content">
                    <div class="card-body ">
                        ...
                        <?php echo e(Form::open(['url' => 'admin/bankingreceipt/store'])); ?>
    ...
    $(document).ready(function() {
            ...
            $('#submit-button').on('click', function(e) {
                ...
                $.ajax({
                    ...
                    url: '<?php echo e(route('admin.bankingreceipt.store')); ?>',
                    data: formData,
                    // dataType: 'json',
                    ...
                    success: function(response) {
                        ...
                        setTimeout(() => {
                            window.location.href =
                                '<?php echo e(route('admin.bankingreceipt')); ?>';
                        }, 800);
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\3psap\resources\views/backend/bankingreceipt/create.blade.php ENDPATH**/ ?>