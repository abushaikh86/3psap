                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <?php echo e(Form::select('variant', $variants, null, ['class' => 'select2 form-control variant', 'placeholder' => 'Select Variant', 'id' => 'variant'])); ?>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <?php echo e(Form::number('unit_case', null, ['class' => 'form-control', 'placeholder' => 'Enter Units/ Case Or Case Config', 'id' => 'unit_case'])); ?>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <?php echo e(Form::select('hsncode_id', $hsncodes, null, ['class' => 'select2 form-control hsncode_id', 'placeholder' => 'Please Select HSN Code'])); ?>
                                    ...
                                    <div class="col-md-12 col-12">
                                        <?php echo e(Form::label('unit_case', 'UoM Group ')); ?>
                                        ...
                                        <table class='table borderd'>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php echo e(Form::text('at_qty[]', null, ['class' => 'form-control ', 'placeholder' => 'Please Enter Quantity'])); ?>

                                                    </td>

                                                    <td>
                                                        <?php echo e(Form::select('at_uom[]', $uom_types, null, ['class' => 'form-control ', 'placeholder' => 'Please Select UoM Type'])); ?>
                                                    ...
                                                    <td>
                                                        <?php echo e(Form::text('base_qty[]', null, ['class' => 'form-control ', 'placeholder' => 'Please Enter Quantity'])); ?>

                                                    </td>

                                                    <td>
                                                        <?php echo e(Form::select('base_uom[]', $uom_types, null, ['class' => 'form-control ', 'placeholder' => 'Please Select UoM Type'])); ?>

                                                    </td>

                                                    <td>
                                                        <?php echo e(Form::checkbox('is_active[]', null)); ?>
                                    ...
                                    <div class="col-md-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <div class="custom-file">
                                                <?php echo e(Form::file('product_thumb', ['class' => 'custom-file-input', 'id' => 'product_thumb'])); ?>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/parasigh/public_html/3psap/resources/views/backend/products/create.blade.php ENDPATH**/ ?>