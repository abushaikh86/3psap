                ...
                <div class="card-content">
                    <div class="card-body">
                        <div class="content-header row">
                            ...
                            <?php echo e(Form::model($model, ['url' => 'admin/billbooking/update', 'files' => true, 'class' =>
                            'w-100'])); ?>
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <div class="col-md-12 col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        <?php echo e(Form::select('vendor_id', $party_code, null, [
                                                ...
                                                <div class="col-md-12 col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        <?php echo e(Form::select('vendor_id', $party, null, [
                                                        'class' => 'form-control tags',
                                                        'id' => 'party_id',
                                                ...
                                                <table class="table table-bordered " id="repeater" style="width:120%;">
                                                    <thead class="bg-light" style="font-size:10px;">
                                                        <tr>
                                                            ...
                                                            <td><?php echo e(Form::label('amount', 'Amount', ['class' =>
                                                    ...
                                                    <tbody data-repeater-list="invoice_items">
                                                        ...
                                                        <tr data-repeater-item class="item_row item-content"
                                                            ...
                                                            <td><?php echo e(Form::text('old_invoice_items[' . $loop->index .
                                                            ...
                                                            <td class="adjust_col">
                                                                <?php echo e(Form::text('old_invoice_items[' . $loop->index .
