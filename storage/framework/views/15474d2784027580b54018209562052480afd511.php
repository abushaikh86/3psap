<?php $__env->startSection('title', 'Create Bill Booking '); ?>
                ...
                <div class="card-content">
                    <div class="card-body">
                        <div class="content-header row">
                            ...
                            <?php echo e(Form::open(['url' => 'admin/billbooking/store'])); ?>
                                    ...
                                    <div class="col-sm-6">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <div class="col-md-12 col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        <?php echo e(Form::select('vendor_id', $party, null, ['class' =>
                                                ...
                                                <div class="col-md-12 col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        <?php echo e(Form::date('invoice_ref_date', null, ['class' =>
                                        ...
                                        <div class="col-md-3 col-sm-3">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <?php echo e(Form::date('bill_date', date('Y-m-d'), ['class' => 'form-control ',
                                            ...
                                            <div class="form-group">
                                                ...
                                                <?php echo e(Form::date('posting_date', date('Y-m-d'), ['class' => 'form-control
                                                    ...
                                                    <table class="table table-bordered " id="repeater"
                                                        ...
                                                        <thead class="bg-light" style="font-size:10px;">
                                                            <tr>
                                                                ...
                                                                <td><?php echo e(Form::label('bsplsubcat_id', 'Expense
                                                                    Sub-Category')); ?>
                                                                ...
                                                                <td><?php echo e(Form::label('amount', 'Amount')); ?></td>
                                                        ...
                                                        <tbody data-repeater-list="invoice_items">
                                                            ...
                                                            <tr data-repeater-item class="item_row ">
                                                                ...
                                                                <td><?php echo e(Form::text('description',
                                                                ...
                                                                <td class="adjust_col">
                                                                    <?php echo e(Form::text('invoice_ref_no',
                                                                ...
                                                                <td class="adjust_col">
                                                                    <?php echo e(Form::select('expense_id', $expense_data,
                                                                ...
                                                                <td class="adjust_col">
                                                                    <?php echo e(Form::select('bsplstype_id', [],
                                                                ...
                                                                <td class="adjust_col">
                                                                    <?php echo e(Form::select('bsplsubcat_id', [],
                                                                ...
                                                                <td class="adjust_col">
                                                                    <?php echo e(Form::select('bsplcat_id', [],
                                                                ...
                                                                <td class="adjust_col">
                                                                    <?php echo e(Form::select('bsplheads_id', [],
                                                                ...
                                                                <td class="adjust_col">
                                                                    <?php echo e(Form::select('gl_code', [],
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/3psap/resources/views/backend/billbooking/create.blade.php ENDPATH**/ ?>