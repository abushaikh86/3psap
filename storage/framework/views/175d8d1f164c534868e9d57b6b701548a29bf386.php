...
<div class="table-responsive printable mb-4">
    ...
    <table class="table table-bordered table-striped table-hover" border="1">
            ...
            <tr>
                <td colspan="7">
                    <table width="100%" class="no-border">
                        <tr>
                            <td width="80">
                                <img class="img-fluid for-light" src="<?php echo e(asset('public/assets/images/logo/logo.png')); ?>"
                                    width="80" alt="">
                            </td>
                            <td>
        ...
        <tbody>
            ...
            <tr>
                <td colspan="2"><?php echo e($invoice->doc_no); ?></td>
                <td colspan="2"><?php echo e(Carbon::parse($invoice->bill_date)->format('d-m-Y')); ?></td>
                <td colspan="3"><?php echo e($party->gst_details); ?></td>
            </tr>
            <tr>
                <td colspan="3">GSTIN/UIN: <?php echo e($party->gst_details); ?></td>
            </tr>
            <tr>
                <th>Sr.No</th>
            ...
            <?php
                $total_sum = 0;
            ?>
            <?php if($banking_items): ?>
                <?php $i=1;   ?>
                <?php $__currentLoopData = $banking_items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php
                    ...
                    <tr>
                        <td><?php echo e($i++); ?></td>
                        <td><?php echo e($bill_booking->doc_no); ?></td>
                        <td colspan="3"><?php echo e($item->description); ?></td>
                        <td colspan="2"><?php echo e($item->amount); ?></td>
                    </tr>
...
<?php endif; ?>
<?php /**PATH /var/www/html/3psap/resources/views/backend/bankingpayment/invoice_format.blade.php ENDPATH**/ ?>