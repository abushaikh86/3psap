          ...
          <div class="container mt-3 pb-5 contain-full">
            ...
            <div class="row">
              ...
              <form class="contact-form form-field" action="" method="post" onsubmit="return mycontact()">
                ...
                <div class="form-group col-md-12 pb-3">
                <!-- <div class="input-wrapper">
                <input class="form-control form-control-h" type="text" id="mobnumber" minlength="10" maxlength="10" inputmode="numeric" pattern="[0-9]*" required>
                ...
                <div class="input-wrapper shipping_mob_no">
                          <input class="form-control form-control-h" type="text" name="shipping_mobile_no" value="" minlength="10" maxlength="10" inputmode="numeric" pattern="[0-9]*" required>
                          <label class="enter-mob-no" for="user">Mobile Phone Number <span class="star">*</span></label>
                        </div>
                        <div class="countryCode-wrap countryCode-wrap2">
