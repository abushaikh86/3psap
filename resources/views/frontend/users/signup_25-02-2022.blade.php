        ...
        <div class="border-login">
          <div class="using-box">
              ...
              <form class="registration-form form-field" action="{{ url('register') }}" method="POST" onsubmit="return myRegistration()">
                ...
                <div class = "form-group col-md-12 pb-4">
                <!-- <div class="input-wrapper">
                <input class="form-control form-control-h" type="text" id="mobnumber" name="mobile_no" maxlength="10" required>
                <label for="user">Mobile Phone Number <span class="star">*</span></label>
                <span class="number-msg" id="messages"></span>
                </div> -->
                <div id="web_mobile_no" class="xgroup showCountryCode dynamicCountryCode">
                            <div class="input-wrap"><div class="countryCode-wrap">
                              <div class="country-code-dropdown-icon d-flex justify-content-between align-items-center"><div class="cntry-mob-phone-code-item d-flex justify-content-start align-items-center"><img src="https://images.bewakoof.com/web/india-flag-round-1639566913.png" alt="country flag"><span>+91</span></div></div>
                            </div>
                            <input class="error-box" id="mobile_number" type="tel" name="mobile" placeholder="Enter Mobile Number" maxlength="10" data-phonecode="+91" value="">
                            <div class="msgs"><!-- <p class="error">Mobile Number is required</p> --></div></div>
                          </div>
                </div>
                <div class="form-group col-md-12 pb-4">
                <div class="input-wrapper">
