                      ...
                      <form class="login-form form-field" action="{{ route('changeforgotpassword.store') }}" method="post">
                        ...
                        <div class="form-group col-md-12">
                          <div class="input-wrapper">
                            <input class="password form-control form-control-h" id="otp"  name="otp" type="text" required >
...
{{--                        <input type="hidden" name="email" id="email" value="{{$email}}">--}}
                        <div class="form-group col-md-12 mb-0 terms-conditions-size1">
                      <button type="submit" class="cancel-btn btn-block mt-4 text-center" >Resend OTP</button>
                        </div>
                      </form>
                  </div>
                </div>
