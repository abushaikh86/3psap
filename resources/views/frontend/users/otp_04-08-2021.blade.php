              ...
              <div class="border-login py-4">
                ...
                <div class="row ">
                  <div class="col-md-12 col-sm-12 col-12">
                    <div class="login">
                      <form class="login-form form-field" action="{{ url('verifyotp') }}" method="post">
                        {{ csrf_field() }}
                        <div class="form-group col-md-12">
                          <div class="input-wrapper">
                            <input class="password form-control form-control-h"  name="otp" type="text" required>
                          <label for="user">Enter OTP <span class="star">*</span></label>
                          </div>
                          <p class="mb-0 py-2 set-otp">OTP sent to your mobile phone</p>
