                    ...
                    <div class="login">
                      ...
                      <form class="login-form form-field" action="{{ url('/loginstore') }}" method="post">
                        ...
                        <div class="form-group col-md-12 mb-0 terms-conditions-size pt-1">
                          ...
                          <p class=" mb-0">By Login, you agree to Dadreeios.com’s <a href="{{ url('/') }}/pages/terms-and-conditions" class="terms-underline" target="_blank"> Terms & Conditions</a> and <a href="{{ url('/') }}/pages/privacy-policy" class="terms-underline" target="_blank">Privacy Policy</a>.</p>
                        </div>
                      </form>
                  </div>
                </div>
