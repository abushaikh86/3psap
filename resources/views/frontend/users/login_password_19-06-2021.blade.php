                      ...
                      <form class="login-form form-field" action="{{ url('/loginstore') }}" method="post">
                        ...
                        <div class="form-group  col-md-12">
                          <div class="input-wrapper">
                            <input class="password form-control form-control-h change_passsword show_password"  name="password" type="password" required autocomplete="off">
                        ...
                        <div class="form-group col-md-12 mb-0 terms-conditions-size pt-3">
