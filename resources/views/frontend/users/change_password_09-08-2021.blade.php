              ...
              <div class="border-login py-4">
                ...
                <div class="row ">
                  <div class="col-md-12 col-sm-12 col-12">
                    <div class="login">
                      <form class="login-form form-field" action="{{ url('storeforgotpassword') }}" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
...
{{--                        <input  name="email" type="hidden" value="{{$user->email}}">--}}
                        ...
                        <div class="form-group col-md-12 pb-1">
                          <div class="input-wrapper">
                        <input class="password form-control form-control-h show_confirm_password"  name="new-password_confirmation" type="password" required>
