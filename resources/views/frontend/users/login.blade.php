        ...
        <div class="border-login">
          ...
          <div class="row text-center pt-1">
            <div class="col-md-6 col-sm-6 col-6">
                  <a class="social-text facebook btn-block" href="{{ (isset($login_management)&&$login_management->login_management_facebook == 1)? url('login/facebook') : '#' }}">
                    <img src="{{ asset('public/frontend-assets/images/facebook-logo.png') }}" alt="" width="30"> Login with Facebook
                  </a>
            </div>
            <div class="col-md-6 col-sm-6 col-6 ">
                <a class="social-text google btn-block" href="{{ (isset($login_management)&&$login_management->login_management_google == 1)? url('login/google') : '#' }}">
              ...
              <div class="login">
                ...
                <form class="login-form form-field" action="{{ url('/loginpassword') }}" method="post">
                  ...
                  <div class="form-group mb-0 terms-conditions-size pt-3">
                        <button type="submit" class="cobntinue-btn btn-block text-center" @if(isset($login_management)&&$login_management->login_management_login == 0)disabled @endif>Continue</button>
          ...
          <div class="row  text-center pb-3">
            <div class="col-lg-12 col-md-12 col-sm-12 col-12">
              <div class="num-text">
                ...
                <a class="signin" href="{{ (isset($login_management)&&$login_management->login_management_google == 1)? url('signup') : '#' }}">Sign up</a>
              </div>
            </div>
          </div>
        </div>
