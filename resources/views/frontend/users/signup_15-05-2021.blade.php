...
<!-- Registration -->
<div class="container-fluidcustom top-padding regi-page">  <!-- pt-5 -->
    <div class="login-box">
      ...
      <div class="col-lg-6 col-md-6 col-sm-12 col-12">
        <div class="border-login">
          <div class="using-box">
              ...
              <form class="registration-form" action="" method="post" onsubmit="return myRegistration()">
                <div class="form-row">
                ...
                <div class="form-group col-md-12 pb-1">
                  <div class="input-wrapper">
                <input class="password form-control form-control-h"  name="login[repassword]" type="password" required>
                  <label for="user">Re Enter Password <span class="star">*</span></label>
                  <div class="hide-showRe">
                    <span>Show</span>
                  </div>
                  <p class="terms-conditions-size"><i class="fa fa-info" aria-hidden="true"></i> Password must be at least 8 characters alphanumerical.</p>
                  </div>
                  </div>
                <div class="form-group col-md-12">
                  <div class="form-row">
              ...
              <div class="row using-box text-center pb-3">
                <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                  <div class="num-text mb-0">
                    <span>Already have an account? <span><a class="signin" href="login.html">Login</a></span></span>
                  </div>
                </div>
              </div>
