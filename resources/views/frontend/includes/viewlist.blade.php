                  ...
                  <div class="swatches-colors">
                    <div class="swatch-color clearfix" data-option-index="1">
                      ...
                      <div data-value="Red" class="swatch-element color red available">
                        <input quickbeam="color" id="swatch-1-red" type="checkbox" name="option-1" value="Red"  />
                        <label for="swatch-1-red" style="border-color: #000;">
                          <span style="background-color: red;"></span>
                        </label>
                      </div>
                       @endforeach -->
                      <!-- <div data-value="Yellow" class="swatch-element color yellow available">
                        <input quickbeam="color" id="swatch-1-yellow" type="checkbox" name="option-1" value="Yellow"  />
                        <label for="swatch-1-yellow" style="border-color: #000;">
                          <span style="background-color: yellow;"></span>
                        </label>
                      </div> -->
                      <!-- <div data-value="Black" class="swatch-element color black available">
                        <input quickbeam="color" id="swatch-1-black" type="checkbox" name="option-1" value="Black"   />
                        <label for="swatch-1-black" style="border-color: #000;">
                          <span style="background-color: #000;"></span>
                        </label>
                      </div> -->
                      <!-- <div data-value="Green" class="swatch-element color green available">
                        <input quickbeam="color" id="swatch-1-green" type="checkbox" name="option-1" value="Green"   />
                        <label for="swatch-1-green" style="border-color: #000;">
