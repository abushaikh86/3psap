    ...
    <div class="row pt-5">
      <div class="col-md-12">
        <div class="payment-btn-group">
          <p class="pb-4" id="success-button"><a class="payment-view-order-button mr-2" href="{{url('/')}}" class="btn waves-effect waves-light orange lighten-1 btn-update-cart">View Order</a></p>
