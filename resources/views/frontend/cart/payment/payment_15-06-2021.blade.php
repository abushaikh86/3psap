...
$MERCHANT_KEY = "gtKFFx";//"gtKFFx";//fGt7UPa8//AgchnRvO

// Merchant Salt as provided by Payu
$SALT = "eCwWELxi";//"eCwWELxi";//OSCmGKDVTT//OXmajpslMQ
...
//var_dump($_POST);exit;
?>
<div class="container custom-container center PT100">
  ...
  <input type="hidden" name="_token" value="<?php echo $posted['_token']; ?>">
      ...
      <table>
        ...
        <tr>
          ...
          <td><input name="shipping_method_code" value="<?php echo $posted['shipping_method_code']; ?>" /></td>
          <td>Shipping Method Cost: </td>
          <td><input name="shipping_method_cost" value="<?php echo $posted['shipping_method_cost']; ?>" /></td>
