...
?>
    ...
    <div class="row pt-5">
      <div class="col-md-12">
        <p class="text-center" id="fail-button" style=""><a class="payment-view-order-button" href="{{url('cart/reviewcart')}}" class="btn waves-effect waves-light orange lighten-1">Try Again</a></p>
