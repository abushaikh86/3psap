  ...
  <div class="row today-deals my-auto ">
    <div class="col-lg-1 col-md-2 col-sm-2 col-4 ">
      <div class="today-timerimg">
        <img src="{{ asset('public/frontend-assets/images/Today\'s-special-deals-clock-image.jpg') }}" class="img-fluid" alt="">
        <!--timer-todays.jpg-->
      </div>
    </div>
        ...
        <div class=" card ">
           <div class="container1">
            <a href="{{ url('dp/') }}/{{ $product->category_slug }}/{{ $product->sub_category_slug }}/{{ $product->sub_sub_category_slug }}/{{ $product->product_slug }}" target="_blank">
                <img class="img-fluid" src="{{ asset('public/backend-assets/uploads/product_images/'.(isset($imageList[$product->product_id])?$imageList[$product->product_id]:'')) }}" alt="Img">
              
              <div class="pro-details img-border-up">
                 <p class="pro-name mb-0"> {{ (isset($product->brands->brand_name))?$product->brands->brand_name:'&nbsp' }}</p>
