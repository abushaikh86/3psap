            ...
            @include('frontend.includes.errors')
              ...
              {{ csrf_field() }}
							...
							<div class="form-group col-md-12 remove-margin">
								...
								<div class="form-group col-md-12">
    								<!--<div class="input-wrapper">-->
    								<!--<input class="form-control form-control-h" type="text" id="mobnumber" name="mobile_no" value="{{ $user->mobile_no }}" minlength="10" maxlength="10" inputmode="numeric" pattern="[0-9]*" required="">-->
    								...
    								<div class="input-wrapper shipping_mob_no">
                                        <input class="form-control form-control-h" type="text" id="mobnumber" name="mobile_no" minlength="10" maxlength="10" inputmode="numeric" pattern="[0-9]*" value="{{ $user->mobile_no }}" required>
                                        <label class="" for="user">Mobile Phone Number <span class="star">*</span></label>
                                        <span class="number-msg" id="messages"></span>
    								    <span class="number-verified">Verified</span>
                                    </div>
								...
								<div class="form-group col-md-12">
    								<!--<div class="input-wrapper">-->
    								<!--<input class="form-control form-control-h" type="text" id="mobnumber" name="alt_mobile_no" value="{{ $user->alt_mobile_no }}" minlength="10" maxlength="10" inputmode="numeric" pattern="[0-9]*">-->
    								<!--<label for="user">Alternate Mobile Phone Number</label>-->
    								<!--<span class="number-msg" id="messages"></span>-->
    								<!--</div>-->
    								<div class="input-wrapper shipping_mob_no">
                                        <input class="form-control form-control-h" type="text" id="mobnumber" name="alt_mobile_no" minlength="10" maxlength="10" inputmode="numeric" pattern="[0-9]*" value="{{ $user->alt_mobile_no }}">
                                        <label class="" for="user">Alternate Mobile Phone Number <span class="star">*</span></label>
                                        <span class="number-msg" id="messages"></span>
                                    </div>
                                    <div class="countryCode-wrap">
                                        <div class="country-code-dropdown-icon d-flex justify-content-between align-items-center"><div class="cntry-mob-phone-code-item d-flex justify-content-start align-items-center"><img src="{{ asset('public/frontend-assets/images/') }}/flag-img.png" alt="country flag"><span>+91</span></div></div>
