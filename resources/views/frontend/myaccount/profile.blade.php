								...
								<div class="form-row">
									...
									<div class = "form-group col-md-12">
												<div class="input-wrapper shipping_mob_no">
													<input class="form-control form-control-h enter-mob-no" type="text " name="mobile_no" value="{{ $user->mobile_no }}" minlength="10" maxlength="10" inputmode="numeric" pattern="[0-9]*" required>
