...
<div class="container-fluidcustom " style="padding-top:{{ $homepagesection->padding_top }}rem;padding-bottom:{{ $homepagesection->padding_bottom }}rem;">
		<div class="row shop-categories row-bg pt-4">
			<div class="col-lg-12 col-md-12 col-sm-12 col-12">
				<h1 class="heading-underline">{{ isset($homepagesection->home_page_section_title)?$homepagesection->home_page_section_title:'EXPLORE BOTTOM WEAR'}}</h1>
			</div>
		</div>

		<div class="row pt-4 row-bg pb-4">
