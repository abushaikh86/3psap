...
<div class="container-fluidcustom special-deals-timer pt-4">
		<div class="row shop-now-index row-bg">
			...
			<div class="col-lg-6 my-auto col-md-6 col-sm-6 col-12 text-center timer-p">
				<h1 id="heading" class="timer-heading">{{ isset($homepagesection->home_page_section_sub_title)?$homepagesection->home_page_section_sub_title:''}}</h1>
			...
			<div class="col-lg-3 col-md-3 col-sm-3 col-12 ">
					<a href="{{ $homepagesection->section_childs[1]->home_page_section_child_url }}" ><img src="{{ asset('public/backend-assets/uploads/home_page_section_child_images/'.$homepagesection->section_childs[1]->home_page_section_child_images) }}" class="img-fluid" alt=""></a>
					<!--<div class="img-text">-->
					<!--	<p><span>HAND</span>-PICKED</p>-->
					<!--</div>-->
			</div>
