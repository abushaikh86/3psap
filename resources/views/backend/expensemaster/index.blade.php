                                        ...
                                        @foreach ($details as $data)
                                            <tr>
                                                ...
                                                <td>
                                                  ...
                                                  {
                                                @endphp
                                                    <a href="{{ url('admin/bsplsubcat/bsplcat/' . $data->bsplcat_id) }}" class="btn btn-primary btn-xs">BSPL Sub Categories</a>
                                                @php
                                                  }
                                                @endphp --}}
                                   
                                                    <a href="{{ url('admin/expensemaster/edit/'.$data->expense_id) }}" class="btn btn-primary" title="Edit"><i class="feather icon-edit"></i></a>
