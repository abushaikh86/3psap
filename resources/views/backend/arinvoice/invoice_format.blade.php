...
<table style="width: 100%">
        ...
        <tr>
          ...
          <td colspan="10">
            Bill To
            <h5>{{$invoice->get_bill_toaddress->bp_address_name ?? ''}}</h5>
            Address : {{$invoice->get_bill_toaddress->building_no_name. " ,".$invoice->get_bill_toaddress->street_name ." ,". $invoice->get_bill_toaddress->landmark
            ...
            GSTIN:  {{ $invoice->bill_to_gst_no }}<br />
            State: {{$invoice->get_bill_toaddress->state}}
          </td>
          @endif
