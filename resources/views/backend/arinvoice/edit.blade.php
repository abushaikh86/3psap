                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <div class="content-header row">
                                ...
                                {{ Form::model($model, ['url' => 'admin/arinvoice/update', 'files' => true, 'class' => 'w-100']) }}
                                                                    ...
                                                                    <tbody data-repeater-list="old_invoice_items">
                                                                        ...
                                                                        @foreach ($model->goodsservicereceipts_items as $items)
                                                                            ...
                                                                            <tr data-repeater-item
                                                                                ...
                                                                                {{ Form::hidden('old_invoice_items[' . $loop->index . '][order_fulfillment_item_id]', $items->order_fulfillment_item_id, ['data-name' => 'order_fulfillment_item_id', 'class' => 'form-control item_name typeahead', 'placeholder' => 'Description', 'required' => true, 'autocomplete' => 'off']) }}
                                                                                ...
                                                                                <td>
                                                                                    {{ Form::number('old_invoice_items[' . $loop->index . '][discount_item]', $items->discount_item, ['class' => 'form-control discount_item', 'onchange' => 'calculategst(this)', 'data-name' => 'discount_item', 'data-group' => 'old_invoice_items']) }}
                                                                                </td>
                                                                                                    ...
                                                                                                    <div class="row">
                                                                                                        <div
                                                                                                            ...
                                                                                                            <table
                                                                                                                ...
                                                                                                                @if (isset($items->ar_invoice_batches) && count($items->ar_invoice_batches) > 0)
                                                                                                                    @for ($i = 0; $i < count($items->ar_invoice_batches); $i++)
                                                                                                                        {{-- {{ dd( $items->purchase_order_batches->toArray()) }}  --}}
                                                                                                                        ...
                                                                                                                        <tr>
                                                                                                                            ...
                                                                                                                            <input
                                                                                                                                type="hidden"
                                                                                                                                name="batches][{{ $cnt }}][ar_invoice_batches_id"
                                                                                                                                data-name="batches][{{ $cnt }}][ar_invoice_batches_id"
                                                                                                                                class='form-control modal_items'
                                                                                                                                data-group="old_invoice_items"
                                                                                                                                value="{{ $items->ar_invoice_batches[$i]['ar_invoice_batches_id'] }}"
                                                                                                                                id="">

                                                                                                                            <input
                                                                                                                                type="hidden"
                                                                                                                                name="batches][{{ $cnt }}][order_fulfillment_item_id"
                                                                                                                                data-name="batches][{{ $cnt }}][order_fulfillment_item_id"
                                                                                                                                class='form-control modal_items'
                                                                                                                                data-group="old_invoice_items"
                                                                                                                                value="{{ $items->ar_invoice_batches[$i]['order_fulfillment_item_id'] }}"
                                                                                                                                id="">
                                                                                                                            ...
                                                                                                                            <input
                                                                                                                                ...
                                                                                                                                class='form-control modal_items'
                                                                                                                                data-group="old_invoice_items"
                                                                                                                                value="{{ $items->ar_invoice_batches[$i]['storage_location_id'] }}"
                                                                                                                                id="">
                                                                                                                            ...
                                                                                                                            <td><input
                                                                                                                                    ...
                                                                                                                                    class='form-control modal_items'
                                                                                                                                    data-group="old_invoice_items"
                                                                                                                                    value="{{ $items->ar_invoice_batches[$i]['batch_no'] }}"
                                                                                                                                    id="">
                                                                                                                            </td>
                                                                                                                            <td><input
                                                                                                                                    type="date"
                                                                                                                                    ...
                                                                                                                                    class='form-control modal_items'
                                                                                                                                    data-group="old_invoice_items"
                                                                                                                                    value="{{ $items->ar_invoice_batches[$i]['manufacturing_date'] }}"
                                                                                                                                    id="">
                                                                                                                            </td>
                                                                                                                            <td><input
                                                                                                                                    type="date"
                                                                                                                                    ...
                                                                                                                                    class='form-control modal_items'
                                                                                                                                    data-group="old_invoice_items"
                                                                                                                                    value="{{ $items->ar_invoice_batches[$i]['expiry_date'] }}"
                                                                                                                                    id="">
                                                                                                                            </td>
