...
<div class="col-sm-12 text-sm-end mb-1">
  ...
  @include('backend.arinvoice.invoice_format_split', ['roles'=>$roles,'invoice'=>$goodsservicereceipts,'party'=>$party,'bill_address'=>$bill_address,'ship_address'=>$ship_address,'contact'=>$contact,'download'=>false])
  @else
  @include('backend.arinvoice.invoice_format', ['roles'=>$roles,'invoice'=>$goodsservicereceipts,'party'=>$party,'bill_address'=>$bill_address,'ship_address'=>$ship_address,'contact'=>$contact,'download'=>false])
  @endif
      <div class="row">
