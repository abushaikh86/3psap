<script type="text/javascript">
    ...
    function updateTotals() {
        ...
        $('input.select-row:checked').each(function() {
            ...
            var amount = parseFloat($row.find('td:eq(7)').text()); // Assuming column 7 contains the amount
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    data.forEach(function(item, index) {
                        ...
                        if (check_boxes && item.billbooking_items[0].bill_booking_item_id == check_box_check) {
                            newRow +=
