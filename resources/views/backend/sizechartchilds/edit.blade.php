                          ...
                          <div class="col-md-6 col-12">
                            <fieldset class="form-group">
                              <div class="input-group">
                                ...
                                {{ Form::select('product_type', $product_types , null,['class'=>'select2 form-control ', 'placeholder' => 'Please Select Type','id'=>'product_type','disabled' => true]) }}
                                ...
                                @foreach($product_images as $product_image_id => $image_name)
                                  <div class="col-xl-3 col-md-3 img-top-card">
                                    <div class="card widget-img-top">
                                      <div class="card-content">
                                        <img class="card-img-top img-fluid mb-1" src="{{ asset('public/backend-assets/uploads/product_images/') }}/{{ $image_name }}" alt="Product Image">
                                      </div>
