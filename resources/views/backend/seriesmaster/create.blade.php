                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-6">
                                        <div class="form-label-group">
                                            ...
                                            {{ Form::text('series_number', null, ['class' => 'form-control', 'placeholder' => 'Series Abbreviation', 'required' => true]) }}
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-6">
                                        <div class="form-label-group">
                                            ...
                                            {{ Form::select('module', $modules,null, ['class' => 'form-control', 'placeholder' => 'Select Module Name', 'required' => true]) }}
                                        </div>
                                    </div>
