                ...
                <div class="card-content">
                    <div class="card-body card-dashboard">
                      <div class="col-12 text-right">
                        <a href="{{ route('admin.internaluser.create') }}" class="btn btn-primary"><i class="bx bx-plus"></i> Add </a>
                      </div>
                                  ...
                                  @if(isset($internalusers) && count($internalusers)>0)
                                    ...
                                    <tr>
                                      ...
                                      <td>
                                        <!-- @can('Update') -->
                                        <!-- @endcan -->
                                        <a href="{{ url('admin/internaluser/edit/'.$users->user_id) }}" class="btn btn-primary"><i class="bx bx-pencil"></i></a>
                                        <!-- @can('Delete') -->
                                        <!-- @endcan -->
                                        {!! Form::open([
                                            'method'=>'GET',
