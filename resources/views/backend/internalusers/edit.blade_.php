              ...
              <div class="col-12">
                ...
                <div class="breadcrumb-wrapper col-12">
                  <ol class="breadcrumb p-0 mb-0">
                    <li class="breadcrumb-item"><a href="{{ route('admin.internalusers')}}"><i class="bx bx-home-alt"></i></a>
                    </li>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Edit Internal Users</h4>
                </div>
                <div class="card-content">
                    <div class="card-body card-dashboard">
                      ...
                      <div class="col-12 text-right">
                        <a href="{{ route('admin.internalusers') }}" class="btn btn-primary"><i class="bx bx-users"></i> View </a>
                      </div>
                      <br>
                      @include('backend.includes.errors')
                      {{ Form::open(array('url' => 'admin/internaluser/update')) }}
                      @csrf
                        <div class="form-body">
                          <div class="row">
                              ...
                              <div class="col-md-6 col-12">
                                <div class="form-label-group">
                                   <select name="role_id" id="role_id" class='form-control'>
                                       ...
                                       <option value="{{ $value['id'] }}" @if ($value['id'] == $userdata->role_id)
