                                                                    ...
                                                                    <div class="row justify-content-between item-content"
                                                                        ...
                                                                        <div class="col-md-2 col-sm-12 pr-0">
                                                                            <div class="form-group">
                                                                                ...
                                                                                {{ Form::text('old_invoice_items[' . $loop->index . '][item_name]', $items->item_name, ['data-name' => 'item_name', 'class' => 'form-control item_name typeahead', 'placeholder' => 'Description', 'required' => true]) }}
                                                                                ...
                                                                                <div data-repeater-item>
                                                                                    <div
                                                                                        ...
                                                                                        <div
                                                                                            ...
                                                                                            <div class="form-group">
                                                                                                {{ Form::label('hsn_sac', 'HSN/SAC') }}
                                                                                                {{ Form::text('hsn_sac', null, ['class' => 'form-control hsn_sac', 'placeholder' => 'HSN/SAC', 'data-name' => 'hsn_sac', 'required' => true]) }}
                                                                                            </div>
                                                                                        </div>
                                                                                        ...
                                                                                        <div class="col-md-1 col-sm-12 pl-0 pr-0 ">
                                                                                            <div class="form-group">
                                                                                                {{ Form::label('discount', 'Disocunt') }}
                                                                                                {{ Form::text('discount', null, ['class' => 'form-control discount', 'placeholder' => 'Disocunt', 'onchange' => 'calculategst(this)', 'data-name' => 'discount', 'data-group' => 'invoice_items', 'required' => true]) }}
                                                                                            </div>
                                                                                        </div>
                                                                                        <div class="col-md-1 col-sm-12 pl-0 pr-0 ">
                                                                                            <div class="form-group">
                                                                                                {{ Form::label('price_af_discount', 'After Disocunt') }}
                                                                                                {{ Form::text('price_af_discount', null, ['class' => 'form-control price_af_discount', 'placeholder' => 'Price After Disocunt', 'onchange' => 'calculategst(this)', 'data-name' => 'price_af_discount', 'data-group' => 'invoice_items', 'required' => true]) }}
                                                                                            </div>
                                                                                        </div>
                                                                                        ...
                                                                                        <div class="col-md-1 col-sm-12 pl-0 pr-0 ">
                                                                                            <div class="form-group">
                                                                                                ...
                                                                                                {{ Form::text('gross_total', null, ['class' => 'form-control', 'placeholder' => 'Gross Total', 'onchange' => 'calculategst(this)', 'data-name' => 'gross_total', 'data-group' => 'invoice_items', 'required' => true]) }}
