                                    ...
                                    <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="col-md-12 col-sm-12">
                                                        <div class="form-group">
                                                            {{ Form::label('party_id', 'Vendor Name *') }}
                                                            {{ Form::select('party_id', $party, '', ['class' => 'form-control select2', 'id' => 'bill_to', 'placeholder' => 'Select Vendor Name', 'required' => true]) }}
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="col-md-6 col-sm-12">
                                                <div class="form-group">
                                                    {{ Form::label('bill_to_gst_no', 'Ship From') }}
                                                    {{ Form::text('ship from', '', ['class' => 'form-control bill_to_gst_no', 'placeholder' => 'Vendor Reference Number']) }}
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="col-md-6 col-sm-12">
                                                <div class="form-group">
                                                    {{ Form::label('bill_to_gst_no', 'Delevery Location') }}
                                                    {{ Form::text('bill_to_gst_no', '', ['class' => 'form-control bill_to_gst_no', 'placeholder' => 'Delevery Location']) }}
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="col-md-6 col-sm-12">
                                                <div class="form-group">
                                                    {{ Form::label('bill_to_gst_no', 'Place of Supply') }}
                                                    {{ Form::text('bill_to_gst_no', '', ['class' => 'form-control bill_to_gst_no', 'placeholder' => 'Place of Supply']) }}
                                                </div>
                                            </div>
                                        </div>
