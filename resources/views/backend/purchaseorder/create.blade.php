                                ...
                                <div class="row">
                                    ...
                                    {{-- <div class="col-md-3 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            {{ Form::select('purchase_order_id', $purchaseorder,
                                            $goodsservicereceipt->purchase_order_id, ['class' => ' form-control',
                                            'placeholder' => 'Select Bill to', 'required' => true]) }}
                                        </div>
                                    </div> --}}
                                    ...
                                    <div class="col-md-3 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            {{ Form::select('receipt_type', ['goods' => 'Goods', 'service' =>
                                            'Service'], null, ['class' => 'form-control select2', 'id' =>
                                            'receipt_type', 'placeholder' => 'Select Receipt Type', 'required' => true])
                                            }}
                                        </div>
                                    </div> --}}
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="col-md-12 col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        {{ Form::select('party_id', $party, null, ['class' =>
                                                        'form-control select2', 'id' => 'party_id', 'placeholder' =>
                                                        'Select Bill To', 'required' => true]) }}
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-12 col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        {{ Form::hidden('bill_to_gst_no', null, ['class' =>
                                                        'form-control bill_to_gst_no', 'placeholder' => 'GSTIN/UIN',
                                                        'readonly' => true]) }}
                                                    </div>
                                                </div>
                                                <div class="col-md-12 col-sm-12">
                                                ...
                                                <div class="col-md-12 col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        {{ Form::text('vendor_ref_no', null, ['class' => 'form-control
                                                        vendor_ref_no', 'placeholder' => 'Vendor PO Refrence Number',
                                                        'required' => true]) }}
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-12 col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="ship_from" id="ship_from" class="form-control"
                                                            required></select>
                                                        {{-- {{ Form::select('ship_from', null, ['class' =>
                                                        'form-control ship_from', 'placeholder' => 'Ship From',
                                                        'required' => true]) }} --}}
                                                    </div>
                                                </div>
                                            ...
                                            {{-- <div class="col-sm-6">
                                                <div class="col-sm-12">
                                                    ...
                                                    <textarea name="party_details"
                                                        class="party_input d-none"></textarea>
                                                </div>
                                            </div> --}}
                                    ...
                                    {{-- <div class="col-sm-6"> --}}
                                        ...
                                        <div class="col-md-3 col-sm-3">
                                            ...
                                            {{-- <div class="form-group">
                                                ...
                                                $series_numbers = SeriesMaster::pluck('series_number',
                                                'id')->map(function ($value, $key) {
                                                return $value . '-' . session('fy_year');
                                                });

                                                @endphp
                                                {{ Form::label('series_no', 'Series Number *') }}
                                                {{ Form::select('series_no', $series_numbers, null, ['class' =>
                                                'form-control ship_from', 'placeholder' => 'Select Series
                                                Number','data-name'=>'po', 'required' => true]) }}
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                ', 'placeholder' => 'Posting Date', 'required' => true, 'readonly' =>
                                                true]) }}
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                delivery_date', 'placeholder' => 'Delivery Date', 'required' => true])
                                                }}
                                            </div>

                                            <div class="form-group">
                                                {{ Form::label('document_date', 'Document Date *') }}
                                                {{ Form::date('document_date', date('Y-m-d'), ['class' => 'form-control
                                                document_date', 'placeholder' => 'Document Date', 'required' => true])
                                                }}
                                            </div>
                                                                    ...
                                                                    <table class="table table-bordered " id="repeater"
                                                                        ...
                                                                        <thead class="bg-light" style="font-size:10px;">
                                                                            <tr>
                                                                                ...
                                                                                <td>{{ Form::label('taxable_amount',
                                                                                    'Unit Price') }}
                                                                                </td>
                                                                                {{-- <td>{{ Form::label('discount',
                                                                                    'Disocunt') }}
                                                                                </td> --}}
                                                                                {{-- <td>{{
                                                                                    Form::label('price_af_discount',
                                                                                ...
                                                                                <td>{{ Form::label('Amount', 'GST
                                                                                    Amount') }}
                                                                                </td>
                                                                                <td>{{ Form::label('gross_total', 'Gross
                                                                                    Total') }}
                                                                                </td>
                                                                                <td>{{
                                                                    ...
                                                                    ?>
                                                                            <tr data-repeater-item class="item_row">
                                                                                ...
                                                                                <td>{{ Form::text('hsn_sac',
                                                                                    ...
                                                                                    ?? null, ['class' => 'form-control
                                                                                    hsn_sac', 'data-name' => 'hsn_sac',
                                                                                    'required' => true]) }}
                                                                                </td>
                                                                                <td> {{ Form::number('qty',
                                                                                    old('invoice_items')[$i]['qty'] ??
                                                                                    null, ['class' => 'form-control
                                                                                    qty', 'onchange' =>
                                                                                    'calculategst(this)', 'data-name' =>
                                                                                    'qty', 'data-group' =>
                                                                                ...
                                                                                <td>{{ Form::number('taxable_amount',
                                                                                    ...
                                                                                    ?? null, ['class' => 'form-control
                                                                                    taxable_amount', 'onchange' =>
                                                                                    'calculategst(this)', 'data-name' =>
                                                                                    'taxable_amount', 'data-group' =>
                                                                                    'invoice_items', 'required' =>
                                                                                    true]) }}
                                                                                </td>
                                                                                ...
                                                                                ?? null, ['class' => 'form-control
                                                                                discount_item', 'id' => 'discount_item',
                                                                                ...
                                                                                <td>
                                                                                    ...
                                                                                    ?? null, ['class' => 'form-control
                                                                                    custom-rate all_gst', 'placeholder'
                                                                                    => '%', 'onchange' =>
                                                                                    'calculategst(this)', 'data-name' =>
                                                                                    'cgst_rate', 'data-group' =>
                                                                                    'invoice_items', 'readonly' =>
                                                                                    true]) }}
                                                                                </td>
                                                                                <td>
...
<div class="row">
    ...
    <div class="col-md-3 col-sm-3">
        <div class="form-group">
            ...
            {{ Form::textarea('remarks', null, ['class' => 'form-control remarks', 'placeholder' => 'Remarks', 'style'
            => 'height:100px;']) }}
        </div>
    </div>
    ...
    <div class="col-md-3 col-sm-3">
        ...
        <div>
            <p>Discount: <strong><input type="number" name="discount" id="discount" style="width:30px;"
                        onchange="calculate_grand_total()" value="{{ old('discount') ?? 0 }}"> %</strong>
