                            ...
                            <div class="form-body ">
                                <div class="row">
                                    ...
                                    <div class="col-md-3 col-sm-3">
                                        {{-- <div class="form-group">
                                            ...
                                            {{ Form::select('series_no', [], null, ['class' => 'form-control ship_from', 'placeholder' => 'Select Series Number', 'required'=>true,'readonly' => true]) }}
                                        </div>
                                        <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2 col-sm-12">
                                        ...
                                        <input type="text" name="net_total" value="{{$model->net_total}}" class="netTotal d-none">
                                    </div>
                                    <div class="col-md-2 col-sm-12">
                                        <p>Tax: <strong><span class="taxTotal">0</span></strong></p>
                                        <input type="text" name="tax_total" value="{{$model->tax_total}}" class="taxTotal d-none">
                                    </div>
                                    <div class="col-md-2 col-sm-12">
                                        <p>Gross Total: <strong><span class="grossTotal">0</span></strong></p>
                                        <input type="text" name="gorss_total" value="{{$model->gorss_total}}" class="grossTotal d-none">
                                    </div>
                                </div>
    ...
    $('#submit-button').on('click', function(e) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                setTimeout(() => {
                    window.location.href = '{{ route('admin.bankingpayment') }}';
                }, 800);
