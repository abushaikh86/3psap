...
<div class="table-responsive printable mb-4">
    ...
    <table class="table table-bordered table-striped table-hover" border="1">
            ...
            <tr>
                <td colspan="7">
                    <table width="100%" class="no-border">
                        <tr>
                            <td width="80">
                                <img class="img-fluid for-light" src="{{ asset('public/assets/images/logo/logo.png') }}"
                                    width="80" alt="">
                            </td>
                            <td>
        ...
        <tbody>
            ...
            <tr>
                <td colspan="7" style="font-weight: bold;">Amount Chargeable In Words -
                    {{ $invoice->amount_in_words }}</td>
            </tr> --}}
