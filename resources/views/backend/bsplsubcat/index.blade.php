  ...
  <div class="content-header-right col-md-6 col-12 mb-md-0 mb-2">
    <div class="btn-group float-md-right" role="group" aria-label="Button group with nested dropdown">
      <div class="btn-group" role="group">
        <a class="btn btn-outline-primary" href="{{ route('admin.bsplsubcat.create',['id'=>isset(request()->id)?request()->id:0]) }}">
                                        ...
                                        @foreach ($details as $data)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{ url('admin/bsplsubcat/edit/'.$data->bsplsubcat_id.'?route='.Request::route()->getName()) }}" class="btn btn-primary" title="Edit"><i class="feather icon-edit"></i></a>
