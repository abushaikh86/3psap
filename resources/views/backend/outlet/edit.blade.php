                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-6">
                                        <div class="form-group">
                                            ...
                                            {{ Form::select('sales_execu', $sales_execu_data, $model->sales_execu,
                                    ...
                                    <div class="col-md-6 col-6">
                                        <div class="form-group">
                                            {{ Form::label('ase', 'ASE *') }}
                                            {{ Form::select('ase', $ase_data, $model->ase, ['class' => 'form-control
                                    ...
                                    <div class="col-md-6 col-6">
                                        <div class="form-group">
                                            {{ Form::label('asm', 'ASM *') }}
                                            {{ Form::select('asm', $asm_data, $model->asm, ['class' => 'form-control
