                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-6">
                                    <div class="form-group">
                                        ...
                                        {!! Form::select('beat_day[]', $days, $defaultDayIndex, [
                                        'class' => 'form-control ',
                                        // 'multiple' => 'multiple',
                                        ]) !!}
                                    </div>
                                ...
                                <div class="col-md-6 col-6">
                                    <div class="form-group">
                                        ...
                                        {{ Form::select('salesman', $salesman, Auth::user()->admin_user_id ??
                                ...
                                <div class="col-md-6 col-6">
                                    <div class="form-group">
                                        {{ Form::label('ase', 'ASE *') }}
                                        {{ Form::select('ase', $ase_data, null, ['class' => 'form-control select2',
                                ...
                                <div class="col-md-6 col-6">
                                    <div class="form-group">
                                        {{ Form::label('asm', 'ASM *') }}
                                        {{ Form::select('asm', $asm_data, null, ['class' => 'form-control select2',
