                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <div class="content-header row">
                                ...
                                {{ Form::open(['url' => 'admin/invoice/update']) }}
                                {!! Form::model($model, [
                                    'method' => 'POST',
                                ...
                                {{ Form::hidden('invoice_id', $model->invoice_id) }}
                                                            ...
                                                            <table class="table table-bordered " id="repeater">
                                                                <thead class="bg-light" style="font-size:10px;">
                                                                    <tr>
                                                                        ...
                                                                        <td>{{ Form::label('total', 'Total INR') }}</td>
                                                                ...
                                                                <tbody data-repeater-list="old_invoice_items">
                                                                    ...
                                                                    @foreach ($model->invoice_items as $items)
                                                                        {{-- {{dd($items->toArray())}} --}}
                                                            ...
                                                            <table class="table table-bordered " id="repeater">
                                                                ...
                                                                <tbody data-repeater-list="invoice_items"
                                                                    ...
                                                                    <tr data-repeater-item class="item_row">
                                                                        ...
                                                                        <td>{{ Form::text('gross_total', null, ['class' => 'form-control gross_total', 'onchange' => 'calculategst(this)', 'data-name' => 'gross_total', 'data-group' => 'invoice_items', 'required' => true, 'readonly' => true]) }}
                                                                        </td>
                                                                        <td style="width: 210px;">
                                        ...
                                        <div class="col-md-3 col-sm-3">
                                          ...
                                          <div>
                                              <p>Discount: <strong><input type="number" name="discount" id="discount"
                                                          style="width:30px;" value='{{ $model->discount }}' onchange="calculate_grand_total()">
                                                      %</strong>
