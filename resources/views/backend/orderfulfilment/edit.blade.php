                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <div class="content-header row">
                                ...
                                {{ Form::model($model, ['url' => 'admin/orderfulfilment/update', 'files' => true, 'class' => 'w-100']) }}
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 col-sm-3">
                                            ...
                                            <div class="form-group">
                                                ...
                                                {{ Form::date('due_date', null, ['class' => 'form-control due_date', 'placeholder' => 'Delivery Date', 'required' => true]) }}
                                            </div>
                                                                                                    ...
                                                                                                    <div class="row">
                                                                                                        <div
                                                                                                            ...
                                                                                                            <table
                                                                                                                ...
                                                                                                                @if (isset($items->order_fulfilment_batches) && count($items->order_fulfilment_batches) > 0)
                                                                                                                    @for ($i = 0; $i < count($items->order_fulfilment_batches); $i++)
                                                                                                                        ...
                                                                                                                        <tr>
                                                                                                                            ...
                                                                                                                            <input
                                                                                                                                type="hidden"
                                                                                                                                name="batches][{{ $cnt }}][order_fulfilment_batches_id"
                                                                                                                                data-name="batches][{{ $cnt }}][order_fulfilment_batches_id"
                                                                                                                                class='form-control modal_items'
                                                                                                                                data-group="old_invoice_items"
                                                                                                                                value="{{ $items->order_fulfilment_batches[$i]['order_fulfilment_batches_id'] }}"
                                                                                                                                id="">
                                                                                                                            ...
                                                                                                                            <input
                                                                                                                                ...
                                                                                                                                class='form-control modal_items'
                                                                                                                                data-group="old_invoice_items"
                                                                                                                                value="{{ $items->order_fulfilment_batches[$i]['order_fulfillment_item_id'] }}"
                                                                                                                                id="">
                                                                                                                            ...
                                                                                                                            <input
                                                                                                                                ...
                                                                                                                                class='form-control modal_items'
                                                                                                                                data-group="old_invoice_items"
                                                                                                                                value="{{ $items->order_fulfilment_batches[$i]['storage_location_id'] }}"
                                                                                                                                id="">
                                                                                                                            ...
                                                                                                                            <td><input
                                                                                                                                    ...
                                                                                                                                    class='form-control modal_items'
                                                                                                                                    data-group="old_invoice_items"
                                                                                                                                    value="{{ $items->order_fulfilment_batches[$i]['batch_no'] }}"
                                                                                                                                    id="">
                                                                                                                            </td>
                                                                                                                            <td><input
                                                                                                                                    type="date"
                                                                                                                                    ...
                                                                                                                                    class='form-control modal_items'
                                                                                                                                    data-group="old_invoice_items"
                                                                                                                                    value="{{ $items->order_fulfilment_batches[$i]['manufacturing_date'] }}"
                                                                                                                                    id="">
                                                                                                                            </td>
                                                                                                                            <td><input
                                                                                                                                    type="date"
                                                                                                                                    ...
                                                                                                                                    class='form-control modal_items'
                                                                                                                                    data-group="old_invoice_items"
                                                                                                                                    value="{{ $items->order_fulfilment_batches[$i]['expiry_date'] }}"
                                                                                                                                    id="">
                                                                                                                            </td>
