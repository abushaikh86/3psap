            ...
            <div class="row breadcrumbs-top">
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Create Order Booking</li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="card">
                    <div class="card-content">
                        <div class="card-body">
                            ...
                            {{ Form::open(['url' => 'admin/proforma/store']) }}
                            ...
                            <div class="form-body">
                                <div class="row">
                                    {{-- <div class="col-sm-4">
                                        {{ Form::label('bill_no', 'Proforma No') }}
                                        <h4>3PSAP/{{ $fyear }}/{{ $proforma_counter }}</h4>
                                    </div> --}}
                                    <div class="col-md-3 col-sm-12">
                                        <div class="form-group">
                                            {{-- {{ Form::label('bill_date', 'Proforma Date *') }} --}}
                                            {{ Form::hidden('bill_date', date('Y-m-d'), ['class' => 'datepicker-here form-control digits', 'placeholder' => 'Proforma Date', 'required' => true, 'readonly' => true]) }}
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3 col-sm-3">
                                        ...
                                        <div>
                                            <p>Discount: <strong><input type="number" name="discount" id="discount"
                                                        style="width:30px;" onchange="calculate_grand_total()"> %</strong>
...
$.get(APP_URL + '/admin/purchaseorder/partydetails/' + customer_id, {}, function(
    ...
    if (customer_details) {
        ...
        $(document).ready(function() {
            $("#bill_to").change(function() {
                ...
                if (customer_id != '') {
                    $.get(APP_URL + '/admin/proforma/partydetails/' + customer_id, {}, function(response) {
                        var customer_details = $.parseJSON(response);
                        $(".party").html(customer_details.party_detail);
    ...
    @include('backend.proforma.autocomplete_typeahead_script')
