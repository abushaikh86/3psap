                ...
                <div class="card-content">
                    <div class="card-body card-dashboard">
                      <div class="col-12 text-right">
                        <a href="{{ route('admin.permissions.create') }}" class="btn btn-primary"><i class="bx bx-plus"></i> Add </a>
                      </div>
                                ...
                                <tbody>
                                  @if(isset($permissions) && count($permissions)>0)
                                    ...
                                    <tr>
                                      ...
                                      <td>
                                        <a href="{{ url('admin/permissions/edit/'.$permission->id) }}" class="btn btn-primary"><i class="bx bx-pencil"></i></a>
                                        {!! Form::open([
                                            'method'=>'GET',
                                            'url' => ['admin/permissions/delete', $permission->id],
