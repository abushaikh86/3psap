              ...
              <div class="card">
                ...
                <div class="card-content">
                  <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('admin.permissions.store') }}" class="form">
                      {{ csrf_field() }}
                      <div class="form-body">
                        <div class="row">
                          <div class="col-md-6 col-12">
                            <div class="form-label-group">
                              <!-- <input type="text" id="first-name-column" class="form-control" placeholder="First Name"
                                name="fname-column"> -->
                                {{ Form::text('name', null, ['class' => 'form-control', 'placeholder' => 'Enter Permission Name', 'required' => true]) }}
