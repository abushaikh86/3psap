                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-label-group">
                                            ...
                                            {{ Form::select('bp_category', $business_partner_category, null, ['class' => 'form-control  select2 ', 'placeholder' => 'Business Partner Category', 'required' => true]) }}
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-12 d-none sm_dynamic">
                                        ...
                                        <div class="form-label-group">
                                            ...
                                            {{ Form::select('sales_manager', $sales_manager, null, ['class' => 'form-control select2', 'placeholder' => 'Sales Manager']) }}
                                        </div>
                                    ...
                                    <div class="col-md-6 col-12 d-none sm_dynamic">
                                        ...
                                        <div class="form-label-group">
                                            ...
                                            {{ Form::select('sales_officer', $sales_officer, null, ['class' => 'form-control select2', 'placeholder' => 'Sales Officer']) }}
                                        </div>
                                        {{-- <div class="form-label-group">
                                            {{ Form::label('sales_officer', 'Sales Officer *') }}
                                    ...
                                    <div class="col-md-6 col-12 d-none sm_dynamic">
                                        <div class="form-label-group">
                                            ...
                                            {{ Form::select('salesman', $salesman, null, ['class' => 'form-control select2', 'placeholder' => 'Salesman']) }}
                                        </div>
                                        {{-- <div class="form-label-group">
                                            {{ Form::label('salesman', 'Salesman *') }}
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-label-group">
                                            ...
                                            {{ Form::select('pricing_profile', $pricing_data, null, ['class' => 'form-control', 'placeholder' => 'Select Pricing Profile', 'required' => true]) }}
                                        </div>
                                    </div>
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <div class=" col-12">
                                                    <div class="form-label-group">
                                                        ...
                                                        {{ Form::text('bp_address_name', null, ['class' => 'form-control', 'placeholder' => 'Address Name', 'required' => true]) }}
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <div class=" col-12">
                                                    <div class="form-label-group">
                                                        ...
                                                        {{ Form::text('bp_address_name1', null, ['class' => 'form-control', 'placeholder' => 'Address Name', 'required' => true]) }}
                                                    </div>
                                                </div>
                                                ...
                                                <div class=" col-12">
                                                    <div class="form-label-group">
                                                        ...
                                                        {{ Form::select('country1', [], null, ['class' => 'form-control ', 'required' => true]) }}
                                                    </div>
                                                </div>
                                    ...
                                    <div class="col-md-6 col-12 d-none beat_det">
                                        <div class="form-group">
                                            ...
                                            {{ Form::select('beat_id', Beat::pluck('beat_name', 'beat_id'), null, ['class' => 'form-control select2', 'placeholder' => 'Select Beat']) }}
