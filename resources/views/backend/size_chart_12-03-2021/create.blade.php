...
<script>
  $(document).ready(function()
  {
    ...
    var load_size_ids = $("#size_ids").val();
    if (load_size_type != '' && load_size_ids != '')
    {
      sizechartchilds(load_size_type,load_size_ids);
    }
    ...
    function sizechartchilds(size_type,size_ids)
    {
      $.ajax({
          ...
          data:
          {
            size_type: size_type ,size_ids: size_ids , _token: "{{ csrf_token() }}",
          },
