                                                                ...
                                                                <table class="table table-bordered " id="repeater"
                                                                    ...
                                                                    <tbody data-repeater-list="old_invoice_items">
                                                                        ...
                                                                        <tr data-repeater-item class="item_row item-content"
                                                                            ...
                                                                            {{ Form::hidden('old_invoice_items[' . $i . '][goods_service_receipts_item_id]', null, ['data-name' => 'goods_service_receipts_item_id', 'class' => 'form-control item_name typeahead', 'placeholder' => 'Description', 'required' => true, 'autocomplete' => 'off']) }}


                                                                            {{-- {{ Form::hidden('old_invoice_items[' . $i . '][cgst_rate]', $items->cgst_rate, ['class' => 'form-control custom-rate', 'placeholder' => '%', 'onchange' => 'calculategst(this)', 'data-name' => 'cgst_rate', 'data-group' => 'old_invoice_items']) }} --}}
                                                                            {{ Form::hidden('old_invoice_items[' . $i . '][cgst_amount]', null, ['class' => 'form-control custom-amount cgst_amount', 'placeholder' => 'Amt.', 'onchange' => 'calculategst(this)', 'data-name' => 'cgst_amount', 'data-group' => 'old_invoice_items']) }}

                                                                            {{-- {{ Form::hidden('old_invoice_items[' . $i . '][sgst_utgst_rate]', $items->sgst_utgst_rate, ['class' => 'form-control custom-rate', 'placeholder' => '%', 'onchange' => 'calculategst(this)', 'data-name' => 'sgst_utgst_rate', 'data-group' => 'old_invoice_items']) }} --}}
                                                                            {{ Form::hidden('old_invoice_items[' . $i . '][sgst_utgst_amount]', null, ['class' => 'form-control custom-amount sgst_utgst_amount', 'placeholder' => 'Amt.', 'onchange' => 'calculategst(this)', 'data-name' => 'sgst_utgst_amount', 'data-group' => 'old_invoice_items']) }}

                                                                            {{-- {{ Form::hidden('old_invoice_items[' . $i . '][igst_rate]', $items->igst_rate, ['class' => 'form-control custom-rate', 'placeholder' => '%', 'onchange' => 'calculategst(this)', 'data-name' => 'igst_rate', 'data-group' => 'old_invoice_items']) }} --}}
                                                                            {{ Form::hidden('old_invoice_items[' . $i . '][igst_amount]', null, ['class' => 'form-control custom-amount igst_amount', 'placeholder' => 'Amt.', 'onchange' => 'calculategst(this)', 'data-name' => 'igst_amount', 'data-group' => 'old_invoice_items']) }}
                                                                            ...
                                                                            {{-- </td> --}}
                                                                            {{-- <td>{{ Form::text('old_invoice_items[' . $i . '][price_af_discount]', null, ['class' => 'form-control  price_af_discount', 'onchange' => 'calculategst(this)', 'data-name' => 'price_af_discount', 'data-group' => 'old_invoice_items', 'readonly' => true]) }}
                                                                            </td> --}}
                                                                            <td>{{ Form::text('old_invoice_items[' . $i . '][total]', null, ['class' => 'form-control  total', 'onchange' => 'calculategst(this)', 'data-name' => 'total', 'data-group' => 'old_invoice_items', 'required' => true, 'readonly' => true]) }}
                                                                            </td>
                                                                            ...
                                                                            <td>
                                                                                {{ Form::text('old_invoice_items[' . $i . '][sgst_utgst_rate]', null, ['class' => 'form-control custom-rate all_gst', 'placeholder' => '%', 'onchange' => 'calculategst(this)', 'data-name' => 'sgst_utgst_rate', 'data-group' => 'old_invoice_items', 'readonly' => true]) }}
                                                                            </td>
                                                                            <td>
                                                                                {{ Form::text('old_invoice_items[' . $i . '][igst_rate]', null, ['class' => 'form-control custom-rate all_gst', 'placeholder' => '%', 'onchange' => 'calculategst(this)', 'data-name' => 'igst_rate', 'data-group' => 'old_invoice_items', 'readonly' => true]) }}
                                                                            </td>
                                                                            ...
                                                                            <td>
                                                                                {{ Form::text('old_invoice_items[' . $i . '][batch_no]', null, ['class' => 'form-control', 'data-name' => 'batch_no', 'required' => true]) }}
                                                                            </td>
