...
use App\Models\backend\BackendMenubarSublink;
...
$backend_menubar = BackendMenubar::all();
@endphp
  ...
  <div class="main-menu-content">
    ...
    <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation" data-icon-style="lines">
      ...
      @php
        ...
        {
      @endphp
          <li class=" navigation-header"><span>{{$menu->menu_name}}</span>
          </li>
          <li class=" nav-item"><a href="#"><i class="menu-livicon" data-icon="notebook"></i><span class="menu-title" data-i18n="Invoice">{{$menu->menu_name}}</span></a>
            <ul class="menu-content">
