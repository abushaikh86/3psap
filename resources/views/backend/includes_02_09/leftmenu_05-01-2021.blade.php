...
<div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
  <div class="navbar-header">
    <ul class="nav navbar-nav flex-row">
      <li class="nav-item mr-auto"><a class="navbar-brand" href="{{ route('admin.dashboard') }}">
          <div class="brand-logo"><img class="logo" src="{{ asset('public/backend-assets/images/logo/logo.png') }}"/></div>
          <h2 class="brand-text mb-0">Dadreeios</h2></a></li>
  ...
  <div class="main-menu-content">
    @php
      ...
      //Menu::build($menu_lists, function ($menu, $menu_list) {
      //  $menu->action('ProductController@detail', $menu_list->name, $menu_list->id);
      //});

    @endphp
    <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation" data-icon-style="lines">
      <li class=" nav-item"><a href="{{ route('admin.dashboard') }}"><i class="menu-livicon" data-icon="desktop"></i><span class="menu-title" data-i18n="Dashboard">Dashboard</span></a>
      ...
      @php
        foreach($backend_menubar as $menu)
        {
          if($menu->has_submenu == 1)
          {
            ...
            {
      @endphp
              <li class=" nav-item"><a href="javascript:;"><i class="menu-livicon" data-icon="notebook"></i><span class="menu-title" data-i18n="{{$menu->menu_name}}">{{$menu->menu_name}}</span></a>
                <ul class="menu-content">
      @php
      ...
      @endphp
                  ...
                  <li><a href="{{ $suburl }}"><i class="bx bx-right-arrow-alt"></i><span class="menu-item" data-i18n="{{ $submenu->submenu_name }}">{{ $submenu->submenu_name }}</span></a>
                  </li>
      @php
                }
      @endphp
      ...
      @endphp
            <li class=" nav-item"><a href="{{ $url }}"><i class="menu-livicon" data-icon="{{ ($menu->menu_icon)?$menu->menu_icon:'notebook' }}"></i><span class="menu-title" data-i18n="{{$menu->menu_name}}">{{$menu->menu_name}}</span></a>
      ...
      <li class=" nav-item"><a href="#"><i class="menu-livicon" data-icon="unlink"></i><span class="menu-title" data-i18n="Starter kit">Starter kit</span></a>
        <ul class="menu-content">
          <li><a href="https://www.pixinvent.com/demo/frest-clean-bootstrap-admin-dashboard-template/starter-kit/ltr/vertical-menu-template-semi-dark/sk-layout-1-column.html"><i class="bx bx-right-arrow-alt"></i><span class="menu-item" data-i18n="1 column">1 column</span></a>
          </li>
          <li><a href="https://www.pixinvent.com/demo/frest-clean-bootstrap-admin-dashboard-template/starter-kit/ltr/vertical-menu-template-semi-dark/sk-layout-2-columns.html"><i class="bx bx-right-arrow-alt"></i><span class="menu-item" data-i18n="2 columns">2 columns</span></a>
          </li>
          <li><a href="https://www.pixinvent.com/demo/frest-clean-bootstrap-admin-dashboard-template/starter-kit/ltr/vertical-menu-template-semi-dark/sk-layout-fixed-navbar.html"><i class="bx bx-right-arrow-alt"></i><span class="menu-item" data-i18n="Fixed navbar">Fixed navbar</span></a>
          </li>
          <li><a href="https://www.pixinvent.com/demo/frest-clean-bootstrap-admin-dashboard-template/starter-kit/ltr/vertical-menu-template-semi-dark/sk-layout-floating-navbar.html"><i class="bx bx-right-arrow-alt"></i><span class="menu-item" data-i18n="Floating navbar">Floating navbar</span></a>
          </li>
          <li><a href="https://www.pixinvent.com/demo/frest-clean-bootstrap-admin-dashboard-template/starter-kit/ltr/vertical-menu-template-semi-dark/sk-layout-fixed.html"><i class="bx bx-right-arrow-alt"></i><span class="menu-item" data-i18n="Fixed layout">Fixed layout</span></a>
          </li>
          <li><a href="https://www.pixinvent.com/demo/frest-clean-bootstrap-admin-dashboard-template/starter-kit/ltr/vertical-menu-template-semi-dark/sk-layout-static.html"><i class="bx bx-right-arrow-alt"></i><span class="menu-item" data-i18n="Static layout">Static layout</span></a>
          </li>
        </ul>
      </li>
