...
@section('title', 'Edit Order Boooking')
            ...
            <div class="row breadcrumbs-top">
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Edit Order Boooking</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <div class="content-header row">
                                ...
                                {{ Form::model($model, ['url' => 'admin/orderbooking/update', 'files' => true, 'class' => 'w-100']) }}
                                                                    ...
                                                                    <tbody data-repeater-list="old_invoice_items">
                                                                        ...
                                                                        @foreach ($model->purchaseorder_items as $items)
                                                                            ...
                                                                            <tr data-repeater-item
                                                                                ...
                                                                                {{ Form::hidden('old_invoice_items[' . $loop->index . '][order_booking_item_id]', $items->order_booking_item_id, ['data-name' => 'order_booking_item_id', 'class' => 'form-control item_name typeahead', 'placeholder' => 'Description', 'required' => true, 'autocomplete' => 'off']) }}
                                                                                                    ...
                                                                                                    <div class="row">
                                                                                                        <div
                                                                                                            ...
                                                                                                            <table
                                                                                                                ...
                                                                                                                @if (isset($items->order_booking_batches) && count($items->order_booking_batches) > 0)
                                                                                                                    @for ($i = 0; $i < count($items->order_booking_batches); $i++)
                                                                                                                        ...
                                                                                                                        <tr>
                                                                                                                            ...
                                                                                                                            <input
                                                                                                                                type="hidden"
                                                                                                                                name="batches][{{ $cnt }}][order_booking_batches_id"
                                                                                                                                data-name="batches][{{ $cnt }}][order_booking_batches_id"
                                                                                                                                class='form-control modal_items'
                                                                                                                                data-group="old_invoice_items"
                                                                                                                                value="{{ $items->order_booking_batches[$i]['order_booking_batches_id'] }}"
                                                                                                                                id="">

                                                                                                                            <input
                                                                                                                                type="hidden"
                                                                                                                                name="batches][{{ $cnt }}][order_booking_item_id"
                                                                                                                                data-name="batches][{{ $cnt }}][order_booking_item_id"
                                                                                                                                class='form-control modal_items'
                                                                                                                                data-group="old_invoice_items"
                                                                                                                                value="{{ $items->order_booking_batches[$i]['order_booking_item_id'] }}"
                                                                                                                                id="">
                                                                                                                            ...
                                                                                                                            <input
                                                                                                                                ...
                                                                                                                                class='form-control modal_items'
                                                                                                                                data-group="old_invoice_items"
                                                                                                                                value="{{ $items->order_booking_batches[$i]['storage_location_id'] }}"
                                                                                                                                id="">
                                                                                                                            ...
                                                                                                                            <td><input
                                                                                                                                    ...
                                                                                                                                    class='form-control modal_items'
                                                                                                                                    data-group="old_invoice_items"
                                                                                                                                    value="{{ $items->order_booking_batches[$i]['batch_no'] }}"
                                                                                                                                    id="">
                                                                                                                            </td>
                                                                                                                            <td><input
                                                                                                                                    type="date"
                                                                                                                                    ...
                                                                                                                                    class='form-control modal_items'
                                                                                                                                    data-group="old_invoice_items"
                                                                                                                                    value="{{ $items->order_booking_batches[$i]['manufacturing_date'] }}"
                                                                                                                                    id="">
                                                                                                                            </td>
                                                                                                                            <td><input
                                                                                                                                    type="date"
                                                                                                                                    ...
                                                                                                                                    class='form-control modal_items'
                                                                                                                                    data-group="old_invoice_items"
                                                                                                                                    value="{{ $items->order_booking_batches[$i]['expiry_date'] }}"
                                                                                                                                    id="">
                                                                                                                            </td>
