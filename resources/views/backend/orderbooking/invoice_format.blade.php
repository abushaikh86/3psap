    ...
    <table style="width: 100%">
      ...
      <tr>
        <td colspan="10" rowspan="3" style="width: 100%">
          ...
          <h5 style="text-align:center;padding-top:30px;font-size:20px;margin-bottom:0px;"><b>{{$company->name}}</b></h5>
    ...
    <table style="width: 100%">
      ...
      * ($item->get_product->unit_case * $item->get_product->dimensions_unit_pack));
      ...
      <tr>
        ...
        <td colspan="2">{{ round($item->taxable_amount * $item->qty,2) }}</td>
        {{-- <td colspan="2">
          @php
      ...
      <tr>
        ...
        <td colspan="2">{{ number_format(round($total_inr + $gst_amt, 2), 2, '.', ',') }}</td>
      </tr>
      ...
      <tr>
        ...
        <td colspan="13" style="width: 50%">
          ...
          <b>Total Value after tax : <span style="float:right;">
              {{number_format(round(($total_inr + $gst_amt)-$discount_amount),2,'.',',')}}</span></b><br />
      ...
      <tr>
        ...
        <td colspan="4">{{ $item->taxable_amount }}</td>
