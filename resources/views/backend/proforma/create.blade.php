...
<div class="content-header row">
  ...
  <div class="content-header-right col-md-6 col-12 mb-md-0 mb-2">
    <div class="btn-group float-md-right" role="group" aria-label="Button group with nested dropdown">
      ...
      <a href="{{ route('admin.proforma') }}" class="btn btn-outline-secondary float-right"><i class="bx bx-arrow-back"></i><span class="align-middle ml-25">Back</span></a>
...
<div class="content-header row">
  ...
  {{ Form::open(array('url' => 'admin/proforma/store')) }}
    ...
    <div class="form-body">
      ...
      <div class="col-md-3 col-sm-12">
              <div class="form-group">
                ...
                {{ Form::text('bill_date', date('Y-m-d'), ['class' => 'datepicker-here form-control digits', 'placeholder' => 'Proforma Date', 'required' => true,'readonly'=>true]) }}
              </div>
            </div>
...
<div data-repeater-list="proforma_items">
