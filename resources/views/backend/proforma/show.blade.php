...
<div class="col-sm-12 text-sm-end mb-1">
  ...
  @include('backend.invoice.invoice_format_split', ['roles'=>$roles,'invoice'=>$invoice,'party'=>$party,'download'=>false])
  @else
  @include('backend.invoice.invoice_format', ['roles'=>$roles,'invoice'=>$invoice,'party'=>$party,'download'=>false])
  @endif
      <div class="row">
