                                            ...
                                            <section id="form-repeater-wrapper">
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                                        ...
                                                                        @foreach ($model->goodsservicereceipts_items as $items)
                                                                            ...
                                                                            <tr data-repeater-item
                                                                                ...
                                                                                <td style="width: 210px;">
                                                                                    {{ Form::select('old_invoice_items[' . $loop->index . '][storage_location_id]', $storage_locations, $items->storage_location_id, ['class' => 'form-control  selected_' . $items->storage_location_id, 'data-selected' => $items->storage_location_id, 'placeholder' => 'Warehouse', 'data-name' => 'storage_location_id', 'required' => true]) }}
                                                        ...
                                                        @else
                                                            {{ Form::hidden('old_invoice_items[' . $loop->index . '][batch_no]', $items->batch_no, ['class' => 'form-control  def_batch_no', 'data-name' => 'batch_no', 'data-group' => 'old_invoice_items']) }}
                                                            @endif
                                                            ...
                                                            <td><button type='button'
                                                                    ...
                                                                    id="{{ $loop->index }}" data-repeater-delete><i
        ...
        <div class="col-md-3 col-sm-3">
            ...
            <div>
                <p>Discount: <strong><input type="number" name="discount" id="discount" style="width:30px;"
                            value="{{ $model->discount }}" onchange="calculate_grand_total()">
                        %</strong>
