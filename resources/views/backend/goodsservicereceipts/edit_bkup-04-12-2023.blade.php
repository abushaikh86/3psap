                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <div class="content-header row">
                                ...
                                {{ Form::model($model, ['url' => 'admin/goodsservicereceipts/update', 'files' => true, 'class' => 'w-100']) }}
                                                                    ...
                                                                    <tbody data-repeater-list="old_invoice_items">
                                                                        ...
                                                                        @foreach ($model->goodsservicereceipts_items as $items)
                                                                            ...
                                                                            <tr data-repeater-item
                                                                                ...
                                                                                <td>
                                                                                    {{ Form::number('old_invoice_items[' . $loop->index . '][qty]', $items->qty, ['class' => 'form-control qty', 'onchange' => 'calculategst(this)','oninput' => 'validateInputZero(this)','data-name' => 'qty', 'data-group' => 'old_invoice_items', 'required' => true]) }}
                                                                                </td>
                                                                                <td>
