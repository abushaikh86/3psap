    ...
    <div class="content-header-right col-md-6 col-12 mb-md-0 mb-2">
        <div class="btn-group float-md-right" role="group" aria-label="Button group with nested dropdown">
            <div class="btn-group" role="group">
                ...
                {{-- <a href="{{ url('admin/apinvoice/create') }}" class="btn  btn-outline-primary"><i
                            ...
                            <table class="table zero-configuration" id="tbl-datatable">
                                ...
                                {{-- <thead id="search_input">
                                    <tr>
                                        <th></th>
                                        <th></th>
                                        <th><input type="text" id="purchase_order_no"></th>
                                        <th><input type="text" id="vendor_po_ref_num"></th>
                                        <th><input type="text" id="vendor_inv_no"></th>
                                        <th><input type="text" id="ap_inv_no"></th>
                                        <th><input type="date" id="date"></th>
                                        <th><input type="text" id="invoice_for"></th>
                                        <th>
                                            <div class="dropdown">
                                                <select name="" id="status"
