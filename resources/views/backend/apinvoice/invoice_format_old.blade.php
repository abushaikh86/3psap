...
<div class="table-responsive printable mb-4">
        <table class="table table-bordered table-striped table-hover" border="1">
            ...
            <tbody>
              <tr>
                <td colspan="7" style="text-align:center;font-weight:bold;font-size:20px;">A/P Invoice</td>
              </tr>
              <tr>
                <td colspan="2">A/P Invoice No</td>
                <td colspan="2">A/P Invoice Date</td>
              ...
              <tr>
                ...
                <td colspan="2">{{ $invoice->ship_from }}</td>
              </tr>
              <tr>
            ...
            <tr>
              ...
              <td>
                @foreach($invoice->goodsservicereceipts_items as $item)
                {{ $invoice->sub_total + $item->cgst_amount+$item->sgst_utgst_amount+$item->igst_amount }}
                @endforeach
              </td>
            </tr>
            <tr>
