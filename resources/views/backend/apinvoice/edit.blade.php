                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <div class="content-header row">
                                ...
                                {{ Form::model($model, ['url' => 'admin/apinvoice/update', 'files' => true, 'class' => 'w-100']) }}
                                ...
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                {{ Form::hidden('bill_date', date('Y-m-d'), ['class' => ' form-control digits', 'placeholder' => 'A/P Invoice Date', 'required' => true, 'readonly' => true]) }}
                                            </div>
                                        </div>
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <div class="col-md-12 col-sm-12">
                                                        <div class="form-group">
                                                            ...
                                                            {{ Form::hidden('bill_to_gst_no', null, ['class' => 'form-control bill_to_gst_no', 'placeholder' => 'GSTIN/UIN']) }}
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12 col-sm-12">
                                                        <div class="form-group">
                                                    ...
                                                    <div class="col-md-12 col-sm-12">
                                                        <div class="form-group">
                                                            ...
                                                            {{ Form::text('vendor_ref_no', null, ['class' => 'form-control vendor_ref_no', 'placeholder' => 'Vendor PO Refrence Number', 'required' => true]) }}
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-12 col-sm-12">
                                                        <div class="form-group">
                                                            ...
                                                            {{ Form::text('vendor_inv_no', null, ['class' => 'form-control ', 'placeholder' => 'Vendor Invoice Number', 'required' => true]) }}
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-12 col-sm-12">
                                                        <div class="form-group">
                                                            ...
                                                            {{ Form::text('ap_inv_no', null, ['class' => 'form-control ', 'placeholder' => 'Invoice Number', 'required' => true]) }}
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-12 col-sm-12">
                                                        <div class="form-group">
                                                            ...
                                                            {{ Form::text('place_of_supply', null, ['class' => 'form-control place_of_supply', 'placeholder' => 'Place Of Supply']) }}
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="row">
                                                                    ...
                                                                    <tbody data-repeater-list="old_invoice_items">
                                                                        ...
                                                                        @foreach ($model->goodsservicereceipts_items as $items)
                                                                            ...
                                                                            <tr data-repeater-item
                                                                                ...
                                                                                {{ Form::hidden('old_invoice_items[' . $loop->index . '][sku]', $items->sku, ['class' => 'form-control  sku', 'data-name' => 'sku', 'data-group' => 'old_invoice_items']) }}


                                                                                <td>{{ Form::number('old_invoice_items[' . $loop->index . '][item_code]', $items->item_code, ['data-name' => 'item_code', 'class' => 'form-control item_code typeahead', 'required' => true]) }}
                                                                                </td>

                                                                                <td>{{ Form::text('old_invoice_items[' . $loop->index . '][item_name]', $items->item_name, ['data-name' => 'item_name', 'class' => 'form-control item_name typeahead', 'required' => true, 'oninput' => 'validateInput(this)']) }}
                                                                                </td>
                                                                                <td>
                                                                                    {{ Form::text('old_invoice_items[' . $loop->index . '][hsn_sac]', $items->hsn_sac, ['class' => 'form-control', 'data-name' => 'hsn_sac', 'required' => true]) }}
                                                                                </td>
                                                                                <td>
                                                                                    {{ Form::number('old_invoice_items[' . $loop->index . '][qty]', $items->qty, ['class' => 'form-control qty', 'onchange' => 'calculategst(this)', 'data-name' => 'qty', 'data-group' => 'old_invoice_items', 'required' => true]) }}
                                                                                </td>
                                                                                <td>
                                                                                    {{ Form::number('old_invoice_items[' . $loop->index . '][taxable_amount]', $items->taxable_amount, ['class' => 'form-control taxable_amount', 'onchange' => 'calculategst(this)', 'data-name' => 'taxable_amount', 'data-group' => 'old_invoice_items', 'required' => true]) }}
                                                                                </td>
                                                                              
                                                                                    {{ Form::hidden('old_invoice_items[' . $loop->index . '][discount_item]', $items->discount_item, ['class' => 'form-control discount_item', 'onchange' => 'calculategst(this)', 'data-name' => 'discount_item', 'data-group' => 'old_invoice_items']) }}
                                                                           
                                                                               
                                                                                    {{ Form::hidden('old_invoice_items[' . $loop->index . '][price_af_discount]', $items->price_af_discount, ['class' => 'form-control  price_af_discount', 'onchange' => 'calculategst(this)', 'data-name' => 'price_af_discount', 'data-group' => 'old_invoice_items', 'readonly' => true]) }}
                                                                                ...
                                                                                <td style="width: 130px;">
                                                                                    {{ Form::select('old_invoice_items[' . $loop->index . '][gst_rate]', $gst, $items->gst_rate, ['class' => 'form-control gst_dropdown', 'placeholder' => 'Select GST', 'onchange' => 'calculategst(this)', 'data-name' => 'gst_rate', 'data-group' => 'old_invoice_items', 'required' => true]) }}
                                                                                </td>
                                                                                <td>
                                                                                ...
                                                                                <td>{{ Form::text('old_invoice_items[' . $loop->index . '][gross_total]', $items->gross_total, ['class' => 'form-control gross_total', 'onchange' => 'calculategst(this)', 'data-name' => 'gross_total', 'data-group' => 'old_invoice_items', 'required' => true, 'readonly' => true]) }}
                                                                                </td>
                                                                                                                ...
                                                                                                                @if (isset($items->goods_service_receipts_batches) && count($items->goods_service_receipts_batches) > 0)
                                                                                                                    @for ($i = 0; $i < count($items->goods_service_receipts_batches); $i++)
                                                                                                                        ...
                                                                                                                        <tr>
                                                                                                                            ...
                                                                                                                            {{-- {{ Form::hidden('old_invoice_items[' . $loop->index . '][batches][' . $cnt . '][purchase_order_batches_id ]', $items->purchase_order_batches[$i]['purchase_order_batches_id '], ['class' => 'form-control ']) }} --}}
                                                                                                                            {{-- {{ Form::hidden('old_invoice_items[' . $loop->index . '][batches][' . $cnt . '][purchase_order_id]', $items->purchase_order_batches[$i]['purchase_order_id'], ['class' => 'form-control ']) }} --}}

                                                                                                                            <input
                                                                                                                                type="hidden"
                                                                                                                                name="batches][{{ $cnt }}][goods_service_receipts_batches_id"
                                                                                                                                data-name="batches][{{ $cnt }}][goods_service_receipts_batches_id"
                                                                                                                                class='form-control modal_items'
                                                                                                                                data-group="old_invoice_items"
                                                                                                                                value="{{ $items->goods_service_receipts_batches[$i]['goods_service_receipts_batches_id'] }}"
                                                                                                                                id="">

                                                                                                                            <input
                                                                                                                                type="hidden"
                                                                                                                                name="batches][{{ $cnt }}][goods_service_receipts_item_id"
                                                                                                                                data-name="batches][{{ $cnt }}][goods_service_receipts_item_id"
                                                                                                                                class='form-control modal_items'
                                                                                                                                data-group="old_invoice_items"
                                                                                                                                value="{{ $items->goods_service_receipts_batches[$i]['goods_service_receipts_item_id'] }}"
                                                                                                                                id="">
                                                                                                                            ...
                                                                                                                            <input
                                                                                                                                type="hidden"
                                                                                                                                name="batches][{{ $cnt }}][storage_location_id"
                                                                                                                                data-name="batches][{{ $cnt }}][storage_location_id"
                                                                                                                                class='form-control modal_items'
                                                                                                                                data-group="old_invoice_items"
                                                                                                                                value="{{ $items->goods_service_receipts_batches[$i]['storage_location_id'] }}"
                                                                                                                                id="">
                                                                                                                            ...
                                                                                                                            <td><input
                                                                                                                                    type="text"
                                                                                                                                    name="batches][{{ $cnt }}][batch_no"
                                                                                                                                    data-name="batches][{{ $cnt }}][batch_no"
                                                                                                                                    class='form-control modal_items'
                                                                                                                                    data-group="old_invoice_items"
                                                                                                                                    value="{{ $items->goods_service_receipts_batches[$i]['batch_no'] }}"
                                                                                                                                    id="">
                                                                                                                            </td>
                                                                                                                            <td><input
                                                                                                                                    type="date"
                                                                                                                                    name="batches][{{ $cnt }}][manufacturing_date"
                                                                                                                                    data-name="batches][{{ $cnt }}][manufacturing_date"
                                                                                                                                    class='form-control modal_items'
                                                                                                                                    data-group="old_invoice_items"
                                                                                                                                    value="{{ $items->goods_service_receipts_batches[$i]['manufacturing_date'] }}"
                                                                                                                                    id="">
                                                                                                                            </td>
                                                                                                                            <td><input
                                                                                                                                    type="date"
                                                                                                                                    name="batches][{{ $cnt }}][expiry_date"
                                                                                                                                    data-name="batches][{{ $cnt }}][expiry_date"
                                                                                                                                    class='form-control modal_items'
                                                                                                                                    data-group="old_invoice_items"
                                                                                                                                    value="{{ $items->goods_service_receipts_batches[$i]['expiry_date'] }}"
                                                                                                                                    id="">
                                                                                                                            </td>

                                                                                                                            {{-- <td>
                                                                                                                            {{ Form::text('old_invoice_items[' . $loop->index . '][batches][' . $cnt . '][batch_no]', $items->purchase_order_batches[$i]['batch_no'], ['class' => 'form-control ', 'data-group' => 'old_invoice_items']) }}
                                                                                                                        </td> --}}
                                                                                                                            {{-- <td>{{ Form::date('old_invoice_items[' . $loop->index . '][batches][' . $cnt . '][manufacturing_date]', $items->purchase_order_batches[$i]['manufacturing_date'], ['class' => 'form-control modal_items', 'data-group' => 'old_invoice_items']) }}
                                                                                                                        </td>
                                                                                                                        <td>{{ Form::date('old_invoice_items[' . $loop->index . '][batches][' . $cnt . '][expiry_date]', $items->purchase_order_batches[$i]['expiry_date'], ['class' => 'form-control modal_items', 'data-group' => 'old_invoice_items']) }}
                                                                                                                        </td> --}}
                                                                                                                        </tr>
                                                                                                                        @php $cnt++  @endphp
                                                                                                                    @endfor
                                                                                                                ...
                                                                                                                @if ($cnt < 10)
                                                                                                                    @for ($i = $cnt; $i <= 10; $i++)
                                                                                                                        <tr>
                                                                                                                            ...
                                                                                                                            <td><input
                                                                                                                                    type="text"
                                                                                                                                    name="batches][{{ $i }}][batch_no"
                                                                                                                                    data-name="batches][{{ $i }}][batch_no"
                                                                                                                                    class='form-control modal_items'
                                                                                                                                    data-group="old_invoice_items"
                                                                                                                                    id="">
                                                                                                                            </td>
                                                                                                                            <td><input
                                                                                                                                    type="date"
                                                                                                                                    name="batches][{{ $i }}][manufacturing_date"
                                                                                                                                    data-name="batches][{{ $i }}][manufacturing_date"
                                                                                                                                    class='form-control modal_items'
                                                                                                                                    data-group="old_invoice_items"
                                                                                                                                    id="">
                                                                                                                            </td>
                                                                                                                            <td><input
                                                                                                                                    type="date"
                                                                                                                                    name="batches][{{ $i }}][expiry_date"
                                                                                                                                    data-name="batches][{{ $i }}][expiry_date"
                                                                                                                                    class='form-control modal_items'
                                                                                                                                    data-group="old_invoice_items"
                                                                                                                                    id="">
                                                                                                                            </td>

                                                                                                                            {{-- <td>{{ Form::text('batches][' . $i . '][batch_no', null, ['class' => 'form-control modal_items','data-group'=>'old_invoice_items']) }}
                                                                                                                        </td>
                                        ...
                                        <div class="col-md-2 col-sm-12">
                                            <p>Discount:
                                                <strong>{{ Form::number('discount', null, ['class' => 'w-50', 'placeholder' => '%', 'id' => 'discount', 'required' => true]) }}
                                                </strong>
                                            </p>
                                        </div>
                                        <div class="col-md-2 col-sm-12">
