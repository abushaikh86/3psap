                                                                                            ...
                                                                                            <table class="table">
                                                                                                <!-- innner repeater -->
                                                                                                            ...
                                                                                                            <tr>
                                                                                                                ...
                                                                                                                <td>1</td>
                                                                                                                <td class="items" data-group="test">
                                                                                                                    <input
                                                                                                                        type="text"
                                                                                                                        name="batch_no" data-name="batch_no[0]"
                                                                                                                        id="">
                                                                                                                </td>
                                                                                                                <td>
                                                                                                                    <input
                                                                                                            ...
                                                                                                            <tr class="items" data-group="test">
                                                                                                                <td >2</td>
                                                                                                                <td>
                                                                                                                    <input
                                                                                                                        type="text"
                                                                                                                        name="batch_no" data-name="batch_no[1]"
                                                                                                                        id="">
                                                                                                                </td>
                                                                                                                <td>
                                                                                                                    <input
                                                                                                            ...
                                                                                                            <tr class="items" data-group="test">
                                                                                                                ...
                                                                                                                <td>
                                                                                                                    <input
                                                                                                                        type="text"
                                                                                                                        name="batch_no" data-name="batch_no[2]"
                                                                                                                        id="">
                                                                                                                </td>
                                                                                                                <td>
                                                                                                                    <input
                                                                                                                        type="date"
                                                                                                                        name="manufacturing_date[3]"
                                                                                                                        id="">
                                                                                                                </td>
                                                                                                                <td>
                                                                                                                    <input
                                                                                                            ...
                                                                                                            <tr class="items" data-group="test">
                                                                                                                ...
                                                                                                                <td>
                                                                                                                    <input
                                                                                                                        type="text"
                                                                                                                        name="batch_no" data-name="batch_no[4]"
                                                                                                                        id="">
                                                                                                                </td>
                                                                                                                <td>
                                                                                                                    <input
                                                                                                            ...
                                                                                                            <tr class="items" data-group="test">
                                                                                                                ...
                                                                                                                <td>
                                                                                                                    <input
                                                                                                                        type="text"
                                                                                                                        name="batch_no" data-name="batch_no[5]"
                                                                                                                        id="">
                                                                                                                </td>
                                                                                                                <td>
                                                                                                                    <input
                                                                                                                        type="date"
                                                                                                                        name="manufacturing_date[6]"
                                                                                                                        id="">
                                                                                                                </td>
                                                                                                                <td>
                                                                                                                    <input
                                                                                                            ...
                                                                                                            <tr class="items" data-group="test">
                                                                                                                ...
                                                                                                                <td>
                                                                                                                    <input
                                                                                                                        type="text"
                                                                                                                        name="batch_no" data-name="batch_no[7]"
                                                                                                                        id="">
                                                                                                                </td>
                                                                                                                <td>
                                                                                                                    <input
                                                                                                            ...
                                                                                                            <tr class="items" data-group="test">
                                                                                                                ...
                                                                                                                <td>
                                                                                                                    <input
                                                                                                                        type="text"
                                                                                                                        name="batch_no" data-name="batch_no[8]"
                                                                                                                        id="">
                                                                                                                </td>
                                                                                                                <td>
                                                                                                                    <input
                                                                                                            ...
                                                                                                            <tr class="items" data-group="test">
                                                                                                                ...
                                                                                                                <td>
                                                                                                                    <input
                                                                                                                        type="text"
                                                                                                                        name="batch_no" data-name="batch_no[9]"
                                                                                                                        id="">
                                                                                                                </td>
                                                                                                                <td>
                                                                                                                    <input
