                                ...
                                <tbody>
                                  @if(isset($storagelocations) && count($storagelocations)>0)
                                    ...
                                    <tr>
                                      ...
                                      <td>{{ $storagelocation->get_warehouse_name->storage_location_name??'' }}</td>
                      
                                      <td>
                                        <!-- @can('Update') -->
                                        <!-- @endcan -->
                                        <a href="{{ url('admin/bin/edit/'.$storagelocation->bin_id) }}" class="btn btn-primary" title="Edit"><i class="feather icon-edit"></i></a>
                                        <!-- @can('Delete') -->
                                        <!-- @endcan -->
                                        {!! Form::open([
                                            'method'=>'GET',
