                                                        ...
                                                        <table class="table table-bordered " id="repeater"
                                                            ...
                                                            <tbody data-repeater-list="invoice_items">
                                                                ...
                                                                <tr data-repeater-item class="item_row ">
                                                                    ...
                                                                    <td>{{ Form::text('description', old('invoice_items')[$i]['description'] ?? null, ['data-id' => 'description', 'id' => 'description', 'data-name' => 'description', 'class' => 'form-control  description ', 'autocomplete' => 'off', 'required' => true]) }}
                                                                    </td>

                                                                    <td class="adjust_col">
                                                                        {{ Form::text('invoice_ref_no', old('invoice_items')[$i]['invoice_ref_no'] ?? null, ['class' => 'form-control  invoice_ref_no', 'id' => 'invoice_ref_no', 'placeholder' => 'Refrence Number', 'onchange' => 'calculategst(this)', 'data-name' => 'invoice_ref_no', 'data-group' => 'invoice_items', 'required' => true]) }}
                                                                    </td>

                                                                    <td class="adjust_col">
                                                                        {{ Form::select('expense_id', $expense_data, old('invoice_items')[$i]['expense_id'] ?? null, ['data-id' => 'particular', 'id' => 'expense_id', 'placeholder' => 'Select Particular', 'data-name' => 'particular', 'class' => 'form-control  particular typeahead', 'autocomplete' => 'off', 'required' => true]) }}
                                                                    </td>


                                                                    <td class="adjust_col">
                                                                        {{ Form::select('bsplstype_id', [], old('invoice_items')[$i]['bsplstype_id'] ?? null, ['class' => 'form-control  bsplstype_id', 'placeholder' => 'Select Type', 'onchange' => 'calculategst(this)', 'data-name' => 'bsplstype_id', 'data-group' => 'invoice_items', 'readonly' => true]) }}
                                                                    </td>
                                                                    <td class="adjust_col">
                                                                    ...
                                                                    <td class="adjust_col">
                                                                        {{ Form::select('bsplcat_id', [], old('invoice_items')[$i]['bsplcat_id'] ?? null, ['class' => 'form-control  bsplcat_id', 'placeholder' => 'Select Expense Category', 'onchange' => 'calculategst(this)', 'data-name' => 'bsplcat_id', 'data-group' => 'invoice_items', 'readonly' => true]) }}
                                                                    </td>

                                                                    <td class="adjust_col">
                                                                        {{ Form::select('bsplheads_id', [], old('invoice_items')[$i]['bsplheads_id'] ?? null, ['class' => 'form-control  bsplheads_id', 'id' => 'bsplheads_id', 'placeholder' => 'Select Head', 'onchange' => 'calculategst(this)', 'data-name' => 'bsplheads_id', 'data-group' => 'invoice_items', 'readonly' => true]) }}
                                                                    </td>
                                                                    ...
                                                                    <td>{{ Form::text('amount', old('invoice_items')[$i]['amount'] ?? null, ['class' => 'form-control  total', 'onchange' => 'calculategst(this)', 'data-name' => 'total', 'data-group' => 'invoice_items', 'required' => true]) }}
                                                                    </td>
                                                                    ...
                                                                    <td class="d-none">
                                                                        {{ Form::text('gst_amount', old('invoice_items')[$i]['gst_amount'] ?? null, ['class' => 'form-control  gst_amount', 'onchange' => 'calculategst(this)', 'data-name' => 'gst_amount', 'data-group' => 'invoice_items', 'required' => true, 'readonly' => true]) }}
                                                                    </td>

                                                                    <td>{{ Form::text('total_value', old('invoice_items')[$i]['total_value'] ?? null, ['class' => 'form-control gross_total', 'onchange' => 'calculategst(this)', 'data-name' => 'gross_total', 'data-group' => 'invoice_items', 'readonly' => true]) }}
                                                                    </td>

                                                                    <td><button type='button' id="del_btn"
