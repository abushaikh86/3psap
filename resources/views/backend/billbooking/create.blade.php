                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <div class="col-md-12 col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        'form-control select2', 'id' => 'party_id', 'placeholder' =>
                                                        'Select Vendor', 'required' => true]) }}
                                                    </div>
                                                </div>
                                    ...
                                    {{-- <div class="col-sm-6"> --}}
                                        ...
                                        {{-- <div class="col-md-12 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                {{ Form::file('po_document', ['class' => 'form-control', 'id' =>
                                                'po_document']) }}
                                            </div>
                                        </div> --}}
                                        ...
                                        <div class="col-md-3 col-sm-3">
                                            {{-- <div class="form-group">
                                                ...
                                                {{ Form::select('series_no', $series_numbers, null, ['class' =>
                                                'form-control ship_from', 'placeholder' => 'Select Series Number',
                                                'required' => true]) }}
                                            </div>
                                            <div class="form-group">
                                                {{ Form::label('doc_no', 'Doc Number') }}
                                                {{ Form::text('doc_no', null, ['class' => 'form-control ship_from',
                                                'placeholder' => 'Doc Number', 'readonly' => true]) }}
                                            </div> --}}
                                                    ...
                                                    <table class="table table-bordered " id="repeater"
                                                        ...
                                                        <thead class="bg-light" style="font-size:10px;">
                                                            <tr>
                                                                ...
                                                                <td>{{ Form::label('bsplsubcat_id', 'Expense
                                                                    Sub-Category') }}
                                                                </td>
                                                                ...
                                                                {{-- <td class="">{{ Form::label('gst_rate',
                                                                    'GST',['class' => 'd-block', 'style' =>
                                                                    'width:130px']) }}</td>
                                                                <td>{{ Form::label('CGST', 'CGST (%)',['class' =>
                                                                    'd-block', 'style' => 'width:70px']) }}</td>
                                                                <td>{{ Form::label('SGST', 'SGST (%)',['class' =>
                                                                    'd-block', 'style' => 'width:70px']) }}</td>
                                                                <td>{{ Form::label('IGST', 'IGST (%)',['class' =>
                                                                    'd-block', 'style' => 'width:70px']) }}</td>
                                                                <td>{{ Form::label('total_value', 'Total Value',['class'
                                                        ...
                                                        <tbody data-repeater-list="invoice_items">
                                                            ...
                                                            <tr data-repeater-item class="item_row ">
                                                                ...
                                                                old('invoice_items')[$i]['bill_to_state'] ?? null,
                                                                ['class' => 'form-control bill_to_state', 'onchange' =>
                                                                'calculategst(this)', 'data-name' => 'bill_to_state',
                                                                'data-group' => 'invoice_items', 'required' => true]) }}
                                                                {{ Form::hidden('party_state',
                                                                old('invoice_items')[$i]['party_state'] ?? null,
                                                                ['class' => 'form-control party_state', 'onchange' =>
                                                                'calculategst(this)', 'data-name' => 'party_state',
                                                                'data-group' => 'invoice_items', 'required' => true]) }}

                                                                {{ Form::hidden('cgst_rate', null, ['class' =>
                                                                'form-control custom-rate', 'placeholder' => '%',
                                                                'onchange' => 'calculategst(this)', 'data-name' =>
                                                                'cgst_rate', 'data-group' => 'invoice_items']) }}
                                                                {{ Form::hidden('cgst_amount', null, ['class' =>
                                                                'form-control custom-amount cgst_amount', 'placeholder'
                                                                => 'Amt.', 'onchange' => 'calculategst(this)',
                                                                'data-name' => 'cgst_amount', 'data-group' =>
                                                                'invoice_items']) }}

                                                                {{ Form::hidden('sgst_utgst_rate', null, ['class' =>
                                                                'form-control custom-rate', 'placeholder' => '%',
                                                                'onchange' => 'calculategst(this)', 'data-name' =>
                                                                'sgst_utgst_rate', 'data-group' => 'invoice_items']) }}
                                                                {{ Form::hidden('sgst_utgst_amount', null, ['class' =>
                                                                'form-control custom-amount sgst_utgst_amount',
                                                                'placeholder' => 'Amt.', 'onchange' =>
                                                                'calculategst(this)', 'data-name' =>
                                                                'sgst_utgst_amount', 'data-name' => 'sgst_utgst_amount',
                                                                'data-group' => 'invoice_items']) }}

                                                                {{ Form::hidden('igst_rate', null, ['class' =>
                                                                'form-control custom-rate', 'placeholder' => '%',
                                                                'onchange' => 'calculategst(this)', 'data-name' =>
                                                                'igst_rate', 'data-group' => 'invoice_items']) }}
                                                                {{ Form::hidden('igst_amount', null, ['class' =>
                                                                'form-control custom-amount igst_amount', 'placeholder'
                                                                => 'Amt.', 'onchange' => 'calculategst(this)',
                                                                'data-name' => 'igst_amount', 'data-group' =>
                                                                'invoice_items']) }}
                                                                --}}
                                                                ...
                                                                <td>{{ Form::text('description',
                                                                    old('invoice_items')[$i]['description'] ?? null,
                                                                    ['data-id' => 'description', 'id' => 'description',
                                                                    'data-name' => 'description', 'class' =>
                                                                    'form-control description ', 'autocomplete' =>
                                                                    'off', 'required' => true]) }}
                                                                </td>

                                                                <td class="adjust_col">
                                                                    {{ Form::text('invoice_ref_no',
                                                                    old('invoice_items')[$i]['invoice_ref_no'] ?? null,
                                                                    ['class' => 'form-control invoice_ref_no', 'id' =>
                                                                    'invoice_ref_no', 'placeholder' => 'Refrence
                                                                    Number', 'onchange' => 'calculategst(this)',
                                                                    'data-name' => 'invoice_ref_no', 'data-group' =>
                                                                    'invoice_items']) }}
                                                                </td>

                                                                <td class="adjust_col">
                                                                    {{ Form::select('expense_id', $expense_data,
                                                                    old('invoice_items')[$i]['expense_id'] ?? null,
                                                                    ['data-id' => 'particular', 'id' => 'expense_id',
                                                                    'placeholder' => 'Select Particular', 'data-name' =>
                                                                    'particular', 'class' => 'form-control particular
                                                                    typeahead', 'autocomplete' => 'off', 'required' =>
                                                                    true]) }}
                                                                </td>
                                                                ...
                                                                <td class="adjust_col">
                                                                    ...
                                                                    old('invoice_items')[$i]['bsplstype_id'] ?? null,
                                                                    ['class' => 'form-control bsplstype_id',
                                                                    'placeholder' => 'Select Type', 'onchange' =>
                                                                    'calculategst(this)', 'data-name' => 'bsplstype_id',
                                                                    'data-group' => 'invoice_items', 'readonly' =>
                                                                    true]) }}
                                                                </td>
                                                                <td class="adjust_col">
                                                                    {{ Form::select('bsplsubcat_id', [],
                                                                    old('invoice_items')[$i]['bsplsubcat_id'] ?? null,
                                                                    ['class' => 'form-control bsplsubcat_id',
                                                                    'placeholder' => 'Select Expense Sub-Categroy',
                                                                    'data-name' => 'bsplsubcat_id', 'readonly' => true])
                                                                    }}
                                                                </td>
                                                                <td class="adjust_col">
                                                                    {{ Form::select('bsplcat_id', [],
                                                                    old('invoice_items')[$i]['bsplcat_id'] ?? null,
                                                                    ['class' => 'form-control bsplcat_id', 'placeholder'
                                                                    => 'Select Expense Category', 'onchange' =>
                                                                    'calculategst(this)', 'data-name' => 'bsplcat_id',
                                                                    'data-group' => 'invoice_items', 'readonly' =>
                                                                    true]) }}
                                                                </td>
                                                                ...
                                                                <td class="adjust_col">
                                                                    ...
                                                                    old('invoice_items')[$i]['bsplheads_id'] ?? null,
                                                                    ['class' => 'form-control bsplheads_id', 'id' =>
                                                                    'bsplheads_id', 'placeholder' => 'Select Head',
                                                                    'onchange' => 'calculategst(this)', 'data-name' =>
                                                                    'bsplheads_id', 'data-group' => 'invoice_items',
                                                                    'readonly' => true]) }}
                                                                </td>

                                                                <td class="adjust_col">
                                                                    {{ Form::select('gl_code', [],
                                                                    old('invoice_items')[$i]['gl_code'] ?? null,
                                                                    ['class' => 'form-control gl_code', 'id' =>
                                                                    'gl_code', 'onchange' => 'calculategst(this)',
                                                                    'placeholder' => 'Select GL Code', 'data-name' =>
                                                                    'gl_code', 'data-group' => 'invoice_items',
                                                                    'readonly' => true]) }}
                                                                </td>
                                                                <td class="adjust_col">
                                                                    {{ Form::text('amount',
                                                                    old('invoice_items')[$i]['amount'] ?? null, ['class'
                                                                    => 'form-control total', 'onchange' =>
                                                                    'calculategst(this)', 'data-name' => 'total',
                                                                    'data-group' => 'invoice_items', 'required' =>
                                                                    true]) }}
                                                                </td>
                                                                {{-- <td style="width: 130px;">
                                                                    ...
                                                                    old('invoice_items')[$i]['gst_rate'] ?? null,
                                                                    ['class' => 'form-control gst_type gst_dropdown',
                                                                    'placeholder' => 'Select GST', 'onchange' =>
                                                                    'calculategst(this)', 'data-name' => 'gst_rate',
                                                                    'data-group' => 'invoice_items', 'required' =>
                                                                    true]) }}
                                                                </td>
                                                                ...
                                                                <td>
                                                                    {{ Form::text('cgst_rate',
                                                                    old('invoice_items')[$i]['cgst_rate'] ?? null,
                                                                    ['class' => 'form-control custom-rate all_gst',
                                                                    'placeholder' => '%', 'onchange' =>
                                                                    'calculategst(this)', 'data-name' => 'cgst_rate',
                                                                    'data-group' => 'invoice_items', 'readonly' =>
                                                                    true]) }}
                                                                </td>
                                                                <td>
                                                                    {{ Form::text('sgst_utgst_rate',
                                                                    old('invoice_items')[$i]['sgst_utgst_rate'] ?? null,
                                                                    ['class' => 'form-control custom-rate all_gst',
                                                                    'placeholder' => '%', 'onchange' =>
                                                                    'calculategst(this)', 'data-name' =>
                                                                    'sgst_utgst_rate', 'data-group' => 'invoice_items',
                                                                ...
                                                                <td>
                                                                    {{ Form::text('igst_rate',
                                                                    old('invoice_items')[$i]['igst_rate'] ?? null,
                                                                    ['class' => 'form-control custom-rate all_gst',
                                                                    'placeholder' => '%', 'onchange' =>
                                                                    'calculategst(this)', 'data-name' => 'igst_rate',
                                                                    'data-group' => 'invoice_items', 'readonly' =>
                                                                    true]) }}
                                                                </td>
                                                                <td class="d-none">
                                                                    {{ Form::text('gst_amount',
                                                                    old('invoice_items')[$i]['gst_amount'] ?? null,
                                                                    ['class' => 'form-control gst_amount', 'onchange' =>
                                                                    'calculategst(this)', 'data-name' => 'gst_amount',
                                                                    'data-group' => 'invoice_items', 'required' => true,
                                                                    'readonly' => true]) }}
                                                                </td>

                                                                <td>{{ Form::text('total_value',
                                                                    old('invoice_items')[$i]['total_value'] ?? null,
                                                                    ['class' => 'form-control gross_total', 'onchange'
                                                                    => 'calculategst(this)', 'data-name' =>
                                                                    'gross_total', 'data-group' => 'invoice_items',
                                                                    'readonly' => true]) }}
                                                                </td> --}}
