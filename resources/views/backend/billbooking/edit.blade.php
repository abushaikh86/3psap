                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 col-sm-3">
                                            ...
                                            <div class="form-group">
                                                ...
                                                {{ Form::select('status', ['open' => 'Open', 'close' => 'Close'], null, ['class' => 'form-control status', 'required' => true]) }}
                                            </div>
                                                        ...
                                                        <table class="table table-bordered " id="repeater"
                                                            ...
                                                            <thead class="bg-light" style="font-size:10px;">
                                                                <tr>
                                                                    ...
                                                                    <td>{{ Form::label('amount', 'Amount', ['class' => 'd-block', 'style' => 'width:70px']) }}
                                                                    </td>
                                                            ...
                                                            <tbody data-repeater-list="invoice_items">
                                                                ...
                                                                @foreach ($model->billbooking_items as $items)
                                                                    <tr data-repeater-item class="item_row item-content"
                                                                        ...
                                                                        <td class="adjust_col">
                                                                            {{ Form::text('old_invoice_items[' . $loop->index . '][invoice_ref_no]', $items->invoice_ref_no, ['class' => 'form-control  invoice_ref_no', 'id' => 'invoice_ref_no', 'placeholder' => 'Refrence Number', 'onchange' => 'calculategst(this)', 'data-name' => 'invoice_ref_no', 'data-group' => 'invoice_items']) }}
                                                                        </td>
                                                                        ...
                                                                        <td class="adjust_col">
                                                                            {{ Form::text('old_invoice_items[' . $loop->index . '][amount]', $items->amount, ['class' => 'form-control  total', 'onchange' => 'calculategst(this)', 'data-name' => 'total', 'data-group' => 'invoice_items', 'required' => true]) }}
                                                                        </td>
