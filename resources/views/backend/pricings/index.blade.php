                                ...
                                <tbody>
                                  @if(isset($pricings) && count($pricings)>0)
                                    ...
                                    <tr>
                                      ...
                                      <td><a href="{{route('admin.pricings.setpricing',['id'=>$pricing->pricing_master_id])}}" class="btn btn-sm btn-outline-primary">Update</a></td>
                                      <td>

                                        <a href="{{ url('admin/pricings/edit/'.$pricing->pricing_master_id) }}" class="btn btn-primary" title="Edit"><i class="feather icon-edit"></i></a>
