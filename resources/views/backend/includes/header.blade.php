    ...
    <div class="navbar-wrapper">
        ...
        <div class="navbar-container content">
            <div class="collapse navbar-collapse" id="navbar-mobile">
                ...
                // for ($i = 1; $i <= 2; $i++) { // $previousYear=$currentYear - $i; //
                    // $year_data[$previousYear]=$previousYear; // } // // Sort the array by keys // ksort($year_data); //
                    ...
                    {{-- <div class="from-group">
                        {{ Form::select('curr_year', $year_data, $currentYear, ['id' => 'curr_year', 'class' =>
                        'form-control', 'placeholder' => 'Select Year', 'required' => true]) }}
                    </div> --}}
